...
interface Constants {
    public static final String BOOST_MULTIDEX_DIR_NAME = "zuma_boost_multidex";
    ...
    public static final int EXTRACTED_SUFFIX_LENGTH = ".dex".length();
    ...
    public static final String LOCK_INSTALL_FILENAME = "zuma_boost_multidex.install.lock";
    public static final String LOCK_PREPARE_FILENAME = "zuma_boost_multidex.prepare.lock";
    ...
    public static final String PREFS_FILE = "zuma_boost_multidex.records";
