...
class DexInstallProcessor {
    ...
    /* renamed from: com.ali.mobisecenhance.ld.multidex.DexInstallProcessor$1 */
    class RunnableC14051 implements Runnable {
        final /* synthetic */ Context val$mainContext;

        static {
            SoLoad992979061.loadJ2CSo("cn.damai_shell_alijtca_plus", RunnableC14051.class);
        }

        @Override // java.lang.Runnable
        public native void run();

        RunnableC14051(Context context) {
