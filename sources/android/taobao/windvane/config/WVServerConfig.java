...
public class WVServerConfig {
    ...
    public static boolean isBlackUrl(String str, IWVWebView iWVWebView) {
        return iWVWebView.canUseUrlConfig() ? WVUrlMatchUtils.getInstance().isForbiddenOpen(str) : isBlackUrl(str);
    }
    ...
    public static boolean isThirdPartyUrl(String str, IWVWebView iWVWebView) {
        return iWVWebView.canUseUrlConfig() ? WVUrlMatchUtils.getInstance().isAllowOpen(str) : isThirdPartyUrl(str);
    }
