...
public class UCParamData {
    ...
    public void parse(String str) {
        try {
            ...
            this.scLoadPolicyCd = jSONObject.optString("scLoadPolicyCd", needLoadNeedShareCoreApp() ? LOAD_POLICY_CD_ONLY_LEGAL_VALUE : "");
            this.scCopyToSdcardCd = jSONObject.optString("scCopyToSdcardCd", BasePreInitManager.PRE_RENDER_URL_ADDITION_VALUE);
            ...
            this.scStillUpd = jSONObject.optString("scStillUpd", BasePreInitManager.PRE_RENDER_URL_ADDITION_VALUE);
