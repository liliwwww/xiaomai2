...
public class AppMonitorUtil {
    ...
    public static void commitConifgUpdateError(String str, int i, String str2) {
        ...
        AppMonitor.Alarm.commitFail("WindVane", MONITOR_POINT_UPDATE_CONFIG_INFO, str, Integer.toString(i), str2);
    }
    ...
    public static void commitConifgUpdateSuccess(String str) {
        ...
        AppMonitor.Alarm.commitSuccess("WindVane", MONITOR_POINT_UPDATE_CONFIG_INFO, str);
    }
    ...
    public static void commitInSecurityHost(String str) {
        ...
        AppMonitor.Alarm.commitFail("WindVane", MONITOR_POINT_INSECURITY_HOST, "101", str);
    }
    ...
    */
    ...
    public static void commitSecurityWarning(String str, String str2) {
        ...
        AppMonitor.Alarm.commitFail("WindVane", MONITOR_POINT_SECURITY_WARNING, str2, "101", str);
    }
    ...
    public static void commitZCacheDownLoadTime(String str, long j, long j2, long j3, String str2, boolean z) {
        ...
        try {
            ...
            create.setValue("waitTime", j);
            DimensionValueSet create2 = DimensionValueSet.create();
            create2.setValue("appName", str);
            create2.setValue(NotificationCompat.CATEGORY_MESSAGE, str2);
    ...
    public static void init() {
        try {
            ...
            create24.addDimension(NotificationCompat.CATEGORY_MESSAGE);
            ...
            create33.addDimension("statusCode");
            ...
            create34.addMeasure(createMeasuerWithRange("c", 0.0d, 600000.0d));
            ...
            create34.addMeasure(createMeasuerWithRange("dns", 0.0d, 600000.0d));
            ...
            AppMonitor.register("WindVane", MONITOR_POINT_PERFORMANCE, create34, create33);
