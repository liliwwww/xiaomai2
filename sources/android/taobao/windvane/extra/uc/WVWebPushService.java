                    ...
                    UCCore.notifyCoreEvent(2, bundle, new ValueCallback<Object>() { // from class: android.taobao.windvane.extra.uc.WVWebPushService.2
                        ...
                        public void onReceiveValue(Object obj) {
                            if (obj != null) {
                                ...
                                TaoLog.i(WVWebPushService.TAG, "sendServiceWorkerPushMessage onReceiveValue appid=" + bundle2.getString("appId") + ", messageId=" + bundle2.getString("messageId") + ", result=" + bundle2.getString("result"));
                            }
                        }
                    });
                }
