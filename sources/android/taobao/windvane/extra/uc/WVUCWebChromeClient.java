...
public class WVUCWebChromeClient extends WebChromeClient {
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        if (TaoLog.getLogStatus()) {
            ...
            if (i == 1) {
                TaoLog.d(TAG, "onConsoleMessage: %s at %s: %s", new Object[]{consoleMessage.message(), consoleMessage.sourceId(), String.valueOf(consoleMessage.lineNumber())});
            } else if (i == 2) {
                TaoLog.e(TAG, "onConsoleMessage: %s at %s: %s", new Object[]{consoleMessage.message(), consoleMessage.sourceId(), String.valueOf(consoleMessage.lineNumber())});
                WVUCWebView wVUCWebView = this.mWebView;
                if (wVUCWebView != null) {
                    wVUCWebView.wvErrorManager.reportJSError(consoleMessage);
                    this.mWebView.pageTracker.onPageReceivedJSError();
                }
            } else if (i != 3) {
                TaoLog.d(TAG, "onConsoleMessage: %s at %s: %s", new Object[]{consoleMessage.message(), consoleMessage.sourceId(), String.valueOf(consoleMessage.lineNumber())});
            } else {
                TaoLog.w(TAG, "onConsoleMessage: %s at %s: %s", new Object[]{consoleMessage.message(), consoleMessage.sourceId(), String.valueOf(consoleMessage.lineNumber())});
            }
        }
