...
public class UCCoreStartup {
        ...
        WVThreadPool.getInstance().execute(new Runnable() { // from class: android.taobao.windvane.extra.uc.UCCoreStartup.1
            ...
            public void run() {
                try {
                    ...
                    UCCore.preInitCore(10, GlobalConfig.context, (Object[]) null);
                } catch (Throwable th) {
                    TaoLog.m21e(UCCoreStartup.TAG, "asyncPreprocess fail " + th.getMessage());
                }
            }
        });
    }
    ...
    public void initPreprocess() {
        if (sPreprocessAtomic.compareAndSet(false, true)) {
            try {
                ...
                TaoLog.m21e(TAG, "initPreprocess fail " + th.getMessage());
            }
        }
    }
    ...
    public void preInitUCCore(Context context, String str) {
        ...
        try {
            TaoLog.m24i(TAG, "trying to init uc core");
            ...
            TaoLog.m21e(TAG, "failed to load WVUCWebView " + th.getMessage());
        }
    ...
    public void preloadClass(ClassLoader classLoader) {
        ...
        try {
            UCCore.preInitCore(2, GlobalConfig.context, (Object[]) null);
        } catch (Throwable th) {
            TaoLog.m21e(TAG, "preloadClass fail " + th.getMessage());
        }
    }
    ...
    public void preloadIcu(Context context, String str) {
        ...
        try {
            ...
            TaoLog.m21e(TAG, "preloadIcu fail " + th.getMessage());
        }
    }
    ...
    public void preloadIo(Context context, String str) {
        ...
        try {
            ...
            TaoLog.m21e(TAG, "preloadIo fail " + th.getMessage());
        }
    }
    ...
    public void preloadPak(Context context, String str) {
        ...
        try {
            ...
            TaoLog.m21e(TAG, "preloadPak fail " + th.getMessage());
        }
    }
    ...
    public void preloadSo(Context context, String str) {
        ...
        try {
            ...
            TaoLog.m21e(TAG, "preloadSo fail " + th.getMessage());
        }
    }
