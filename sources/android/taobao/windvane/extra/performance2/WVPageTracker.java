...
public class WVPageTracker {
    ...
    private void analyzeResources() {
        ...
        while (i3 < wVPageTracker.resources.size()) {
            ...
            if (wVResource == null) {
                ...
                if (valueOf.startsWith(ExifInterface.GPS_MEASUREMENT_2D)) {
                    j4++;
    ...
    public void blockURLEnd() {
        if (usable()) {
            ...
            d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("interceptEnd", this.mPageUniqueIdentifier).h(currentTime).d();
    ...
    public void blockURLStart() {
        if (usable()) {
            long currentTime = currentTime();
            d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("interceptStart", this.mPageUniqueIdentifier).h(currentTime).d();
    ...
    public void initEnd() {
        if (usable()) {
            long currentTime = currentTime();
            d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("initEnd", this.mPageUniqueIdentifier).h(currentTime).d();
    ...
    public void initStart(IPerformance iPerformance, IWVWebView iWVWebView) {
        if (usable()) {
            ...
            long currentTime = currentTime();
            d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("initStart", this.mPageUniqueIdentifier).h(currentTime).d();
            onApmStarted();
            onApmStaged(this.stages[0], currentTime);
            onApmAddedProperty("processName", CommonUtils.getProcessName(GlobalConfig.context));
        }
    }
    ...
    public void onPageReceivedFP(long j) {
        if (usable()) {
            if (this.mNavigationStartTS > 0) {
                d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("firstPaint", this.mPageUniqueIdentifier).h(this.mNavigationStartTS + j).d();
            } else {
    ...
    public void onPageReceivedT2(long j) {
        if (usable()) {
            d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("T2", this.mPageUniqueIdentifier).h(j).d();
        }
    }
    ...
    public void onPageStarted(IWVWebView iWVWebView, String str) {
        if (usable()) {
            ...
            long currentTime = currentTime();
            d.a(RVLLevel.Error, RVLOG_PAGE_MODEL).g("startLoad", this.mPageUniqueIdentifier).h(currentTime).d();
            onStateChanged(2);
