package android.taobao.windvane.extra.p001ha;
...
public class UCHAManager implements ValueCallback<Pair<Message, Message>> {
    ...
    /* renamed from: sb */
    private StringBuilder f9sb = new StringBuilder();
    ...
    public void onReceiveValue(Pair<Message, Message> pair) {
        ...
        if (!TextUtils.equals(str4, lastID)) {
            commitUCHA();
            StringBuilder sb = this.f9sb;
            sb.delete(0, sb.length());
            if (z) {
                lastID = str4;
                this.f9sb.append(str2);
            }
        } else if (z) {
            StringBuilder sb2 = this.f9sb;
            sb2.append(str2);
            sb2.append("\n");
        }
        if (TextUtils.equals("bkpg", str3)) {
            TaoLog.m21e(TAG, "linkID:[" + str4 + "];logData:[" + str2 + "]");
            return;
        }
        TaoLog.m24i(TAG, "linkID:[" + str4 + "];logData:[" + str2 + "]");
    }
}
