...
public class WVEventId {
    ...
    public static final int CONFIG_COMMON_UPDATE = 6012;
    ...
    public static final int GET_URLS_BY_APP_NAME = 6011;
    ...
    public static final int ORANGE_REGISTER = 7001;
    ...
    public static final int PAGE_InterceptRequestWithHeaders = 1008;
    ...
    public static final int WV_CORE_SWITCH = 3017;
    ...
    public static final int WV_UCCORE_PREPARED = 3016;
    public static final int ZIPAPP_DOWNLOAD_COMPLETE = 6010;
    public static final int ZIPAPP_DOWNLOAD_START = 6009;
