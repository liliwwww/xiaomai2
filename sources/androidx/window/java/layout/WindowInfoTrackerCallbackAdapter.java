    ...
    private final <T> void addListener(Executor executor, Consumer<T> consumer, Flow<? extends T> flow) {
        ...
        try {
            if (this.consumerToJobMap.get(consumer) == null) {
                this.consumerToJobMap.put(consumer, d.d(i80.a(db1.a(executor)), (CoroutineContext) null, (CoroutineStart) null, new addListener.1.1(flow, consumer, (Continuation) null), 3, (Object) null));
            }
