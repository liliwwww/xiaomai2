...
public class DiffUtil {
    private static final Comparator<Diagonal> DIAGONAL_COMPARATOR = new Comparator<Diagonal>() { // from class: androidx.recyclerview.widget.DiffUtil.1
        ...
        public int compare(Diagonal diagonal, Diagonal diagonal2) {
            return diagonal.f372x - diagonal2.f372x;
        }
    };
    ...
    static class Diagonal {
        ...
        int endX() {
            return this.f372x + this.size;
        }

        int endY() {
            return this.f373y + this.size;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            ...
            if (diagonal == null || diagonal.f372x != 0 || diagonal.f373y != 0) {
        ...
        private void findMatchingItems() {
            for (Diagonal diagonal : this.mDiagonals) {
                for (int i = 0; i < diagonal.size; i++) {
                    int i2 = diagonal.f372x + i;
                    int i3 = diagonal.f373y + i;
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mDiagonals.size() - 1; size >= 0; size--) {
                ...
                int i10 = diagonal.f372x;
                int i11 = diagonal.f373y;
