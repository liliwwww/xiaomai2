...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C12171 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C12171.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C12171.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C12171.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i != 3) {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    } else {
                        C12171.this.val$callback.removeTile(next.arg1, next.arg2);
                    }
                    next = C12171.this.mQueue.next();
                }
            }
        };

        C12171(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    /* loaded from: classes.dex */
    class C12182 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C12182.this.mQueue.next();
                    if (next == null) {
                        C12182.this.mBackgroundRunning.set(false);
                        return;
                    }
                    int i = next.what;
                    if (i == 1) {
                        C12182.this.mQueue.removeMessages(1);
                        C12182.this.val$callback.refresh(next.arg1);
                    } else if (i == 2) {
                        C12182.this.mQueue.removeMessages(2);
                        C12182.this.mQueue.removeMessages(3);
                        C12182.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                    } else if (i == 3) {
                        C12182.this.val$callback.loadTile(next.arg1, next.arg2);
                    } else if (i != 4) {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    } else {
                        C12182.this.val$callback.recycleTile((TileList.Tile) next.data);
                    }
                }
            }
        };

        C12182(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C12182(backgroundCallback);
    }

    @Override // androidx.recyclerview.widget.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C12171(mainThreadCallback);
    }
