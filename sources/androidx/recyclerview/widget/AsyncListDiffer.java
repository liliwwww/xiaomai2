...
public class AsyncListDiffer<T> {
    ...
    public AsyncListDiffer(@NonNull RecyclerView.Adapter adapter, @NonNull DiffUtil.ItemCallback<T> itemCallback) {
        this((ListUpdateCallback) new AdapterListUpdateCallback(adapter), (AsyncDifferConfig) new AsyncDifferConfig.Builder(itemCallback).build());
    }
    ...
    public void submitList(@Nullable List<T> list, @Nullable Runnable runnable) {
        ...
        if (list2 != null) {
            this.mConfig.getBackgroundThreadExecutor().execute(new 1(this, list2, list, i, runnable));
            return;
        }
        this.mList = list;
        this.mReadOnlyList = Collections.unmodifiableList(list);
