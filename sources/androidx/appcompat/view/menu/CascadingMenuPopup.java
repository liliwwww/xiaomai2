...
final class CascadingMenuPopup extends MenuPopup implements View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new 1(this);
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new 2(this);
    private final MenuItemHoverListener mMenuItemHoverListener = new 3(this);
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(DisplayMetrics.getwidthPixels(resources.getDisplayMetrics()) / 2, resources.getDimensionPixelSize(R$dimen.abc_config_prefDialogWidth));
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        MenuAdapter adapter = listView.getAdapter();
        int i2 = 0;
