...
class AppCompatTextViewAutoSizeHelper {
    ...
    StaticLayout createLayout(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i, int i2) {
        ...
        return i3 >= 23 ? Api23Impl.createStaticLayoutForMeasuring(charSequence, alignment, i, i2, this.mTextView, this.mTempTextPaint, this.mImpl) : i3 >= 16 ? Api16Impl.createStaticLayoutForMeasuring(charSequence, alignment, i, this.mTextView, this.mTempTextPaint) : createStaticLayoutForMeasuringPre16(charSequence, alignment, i);
    }
