...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        private void setBackgroundColor(RemoteViews remoteViews) {
            remoteViews.setInt(C1173R.id.status_bar_latest_event_content, "setBackgroundColor", this.mBuilder.getColor() != 0 ? this.mBuilder.getColor() : this.mBuilder.mContext.getResources().getColor(C1173R.color.notification_material_background_media_default_color));
        }
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C1173R.layout.notification_template_big_media_narrow_custom : C1173R.layout.notification_template_big_media_custom;
        }

        @Override // androidx.media.app.NotificationCompat.MediaStyle
        int getContentViewLayoutResource() {
            return this.mBuilder.getContentView() != null ? C1173R.layout.notification_template_media_custom : super.getContentViewLayoutResource();
        }
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C1173R.layout.notification_media_action);
            int i = C1173R.id.action0;
        ...
        RemoteViews generateBigContentView() {
            ...
            applyStandardTemplate.removeAllViews(C1173R.id.media_actions);
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C1173R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                int i2 = C1173R.id.cancel_action;
                applyStandardTemplate.setViewVisibility(i2, 0);
                applyStandardTemplate.setInt(i2, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C1173R.integer.cancel_button_image_alpha));
                applyStandardTemplate.setOnClickPendingIntent(i2, this.mCancelButtonIntent);
            } else {
                applyStandardTemplate.setViewVisibility(C1173R.id.cancel_action, 8);
            }
        ...
        RemoteViews generateContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    ...
                    applyStandardTemplate.addView(C1173R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C1173R.id.end_padder, 8);
                int i2 = C1173R.id.cancel_action;
                applyStandardTemplate.setViewVisibility(i2, 0);
                applyStandardTemplate.setOnClickPendingIntent(i2, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(i2, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C1173R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C1173R.id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C1173R.id.cancel_action, 8);
            }
            return applyStandardTemplate;
        }
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C1173R.layout.notification_template_big_media_narrow : C1173R.layout.notification_template_big_media;
        }

        int getContentViewLayoutResource() {
            return C1173R.layout.notification_template_media;
        }
