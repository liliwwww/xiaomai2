...
class FragmentStore {
    ...
    @Nullable
    FragmentState getSavedState(@NonNull String str) {
    ...
    void restoreSaveState(@NonNull ArrayList<FragmentState> arrayList) {
    ...
    @Nullable
    FragmentState setSavedState(@NonNull String str, @Nullable FragmentState fragmentState) {
