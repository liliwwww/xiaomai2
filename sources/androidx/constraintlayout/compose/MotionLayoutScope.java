...
public final class MotionLayoutScope {
    ...
    public static final class MotionProperties {
        ...
        public final long m5558colorvNxB06k(@NotNull String name) {
            Intrinsics.checkNotNullParameter(name, "name");
            return this.myMeasurer.m5569getCustomColorWaAFU9c(this.myId, name);
        }

        /* renamed from: distance-u2uoSUM, reason: not valid java name */
        public final float m5559distanceu2uoSUM(@NotNull String name) {
            Intrinsics.checkNotNullParameter(name, "name");
            return C0856Dp.m5216constructorimpl(this.myMeasurer.getCustomFloat(this.myId, name));
        }

        /* renamed from: float, reason: not valid java name */
        public final float m5560float(@NotNull String name) {
            Intrinsics.checkNotNullParameter(name, "name");
            return this.myMeasurer.getCustomFloat(this.myId, name);
        }

        /* renamed from: fontSize-kPz2Gy4, reason: not valid java name */
        public final long m5561fontSizekPz2Gy4(@NotNull String name) {
            Intrinsics.checkNotNullParameter(name, "name");
        ...
        public final int m5562int(@NotNull String name) {
            Intrinsics.checkNotNullParameter(name, "name");
    ...
    public final long m5555motionColorWaAFU9c(@NotNull String id, @NotNull String name) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(name, "name");
        return this.myMeasurer.m5569getCustomColorWaAFU9c(id, name);
    }

    /* renamed from: motionDistance-chRvn1I, reason: not valid java name */
    public final float m5556motionDistancechRvn1I(@NotNull String id, @NotNull String name) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(name, "name");
        return C0856Dp.m5216constructorimpl(this.myMeasurer.getCustomFloat(id, name));
    }
    ...
    public final long m5557motionFontSize5XXgJZs(@NotNull String id, @NotNull String name) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(name, "name");
