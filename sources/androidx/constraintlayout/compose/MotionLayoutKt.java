...
public final class MotionLayoutKt {
    ...
    public static final void MotionLayout(@NotNull ConstraintSet constraintSet, @NotNull ConstraintSet constraintSet2, @Nullable Transition transition, float f, @Nullable EnumSet<MotionLayoutDebugFlags> enumSet, @Nullable Modifier modifier, int i, @NotNull Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> function3, @Nullable Composer composer, int i2, int i3) {
        ...
        if (enumSet2.contains(motionLayoutDebugFlags) && Float.isNaN(forcedScaleFactor)) {
            ...
            LayoutKt.MultiMeasureLayout(SemanticsModifierKt.semantics$default(modifier2, false, new MotionLayoutKt$MotionLayoutCore$4(motionMeasurer), 1, null), ComposableLambdaKt.composableLambda(composer, -819896774, true, new MotionLayoutKt$MotionLayoutCore$5(function3, motionLayoutScope, i7)), rememberMotionLayoutMeasurePolicy, composer, 48, 0);
            composer.endReplaceableGroup();
        } else {
    ...
    */
    ...
    public static final ConstraintSet m5538MotionLayoutCore$lambda11(MutableState<ConstraintSet> mutableState) {
        return mutableState.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-16, reason: not valid java name */
    public static final boolean m5540MotionLayoutCore$lambda16(MutableState<Boolean> mutableState) {
        return mutableState.getValue().booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-17, reason: not valid java name */
    public static final void m5541MotionLayoutCore$lambda17(MutableState<Boolean> mutableState, boolean z) {
        mutableState.setValue(Boolean.valueOf(z));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-26, reason: not valid java name */
    public static final float m5542MotionLayoutCore$lambda26(MutableState<Float> mutableState) {
        return mutableState.getValue().floatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-27, reason: not valid java name */
    public static final void m5543MotionLayoutCore$lambda27(MutableState<Float> mutableState, float f) {
        mutableState.setValue(Float.valueOf(f));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: MotionLayoutCore$lambda-8, reason: not valid java name */
    public static final ConstraintSet m5544MotionLayoutCore$lambda8(MutableState<ConstraintSet> mutableState) {
        return mutableState.getValue();
    }
    ...
    public static final MeasurePolicy rememberMotionLayoutMeasurePolicy(final int i, @NotNull EnumSet<MotionLayoutDebugFlags> enumSet, long j, @NotNull final ConstraintSet constraintSet, @NotNull final ConstraintSet constraintSet2, @Nullable final Transition transition, @NotNull final MutableState<Float> mutableState, @NotNull final MotionMeasurer motionMeasurer, @Nullable Composer composer, int i2) {
        ...
        if (z || rememberedValue == Composer.Companion.getEmpty()) {
            motionMeasurer.initWith(constraintSet, constraintSet2, transition, mutableState.getValue().floatValue());
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.constraintlayout.compose.MotionLayoutKt$rememberMotionLayoutMeasurePolicy$1$1
                ...
                public final MeasureResult mo944measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull final List<? extends Measurable> list, long j2) {
                    MeasureResult m140p;
                    Intrinsics.checkNotNullParameter(measureScope, "$this$MeasurePolicy");
                    Intrinsics.checkNotNullParameter(list, "measurables");
                    long m5570performInterpolationMeasureOQbXsTc = MotionMeasurer.this.m5570performInterpolationMeasureOQbXsTc(j2, measureScope.getLayoutDirection(), constraintSet, constraintSet2, transition, list, i, mutableState.getValue().floatValue(), measureScope);
                    int m5376getWidthimpl = IntSize.m5376getWidthimpl(m5570performInterpolationMeasureOQbXsTc);
                    int m5375getHeightimpl = IntSize.m5375getHeightimpl(m5570performInterpolationMeasureOQbXsTc);
                    final MotionMeasurer motionMeasurer2 = MotionMeasurer.this;
                    m140p = MeasureScope.CC.m140p(measureScope, m5376getWidthimpl, m5375getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.constraintlayout.compose.MotionLayoutKt$rememberMotionLayoutMeasurePolicy$1$1$measure$1
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x01a4, code lost:
        ...
        if ((m5542MotionLayoutCore$lambda26(r6) == r22) != false) goto L67;
     */
    @androidx.compose.runtime.Composable
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x0183, code lost:
        ...
        if ((m5542MotionLayoutCore$lambda26(r3) == r23) != false) goto L67;
     */
    @androidx.compose.runtime.Composable
    @kotlin.PublishedApi
    /*
    ...
    */
    ...
    public static final void MotionLayoutCore(@NotNull ConstraintSet constraintSet, @NotNull ConstraintSet constraintSet2, @Nullable Transition transition, float f, @Nullable EnumSet<MotionLayoutDebugFlags> enumSet, @Nullable LayoutInformationReceiver layoutInformationReceiver, @Nullable Modifier modifier, int i, @NotNull Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> function3, @Nullable Composer composer, int i2, int i3) {
        ...
        if (enumSet2.contains(motionLayoutDebugFlags) && Float.isNaN(forcedScaleFactor)) {
            composer.startReplaceableGroup(-1401222327);
            LayoutKt.MultiMeasureLayout(SemanticsModifierKt.semantics$default(modifier3, false, new MotionLayoutKt$MotionLayoutCore$4(motionMeasurer), 1, null), ComposableLambdaKt.composableLambda(composer, -819896774, true, new MotionLayoutKt$MotionLayoutCore$5(function3, motionLayoutScope, i2)), rememberMotionLayoutMeasurePolicy, composer, 48, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1401223142);
    ...
    public static final void MotionLayout(@NotNull ConstraintSet constraintSet, @NotNull ConstraintSet constraintSet2, @Nullable Transition transition, float f, @Nullable EnumSet<MotionLayoutDebugFlags> enumSet, @Nullable LayoutInformationReceiver layoutInformationReceiver, @Nullable Modifier modifier, int i, @NotNull Function3<? super MotionLayoutScope, ? super Composer, ? super Integer, Unit> function3, @Nullable Composer composer, int i2, int i3) {
        ...
        if (enumSet2.contains(motionLayoutDebugFlags) && Float.isNaN(forcedScaleFactor)) {
            composer.startReplaceableGroup(-1401222327);
            LayoutKt.MultiMeasureLayout(SemanticsModifierKt.semantics$default(modifier3, false, new MotionLayoutKt$MotionLayoutCore$4(motionMeasurer), 1, null), ComposableLambdaKt.composableLambda(composer, -819896774, true, new MotionLayoutKt$MotionLayoutCore$5(function3, motionLayoutScope, i5)), rememberMotionLayoutMeasurePolicy, composer, 48, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1401223142);
            Modifier scale = !Float.isNaN(forcedScaleFactor) ? ScaleKt.scale(modifier3, motionMeasurer.getForcedScaleFactor()) : modifier3;
