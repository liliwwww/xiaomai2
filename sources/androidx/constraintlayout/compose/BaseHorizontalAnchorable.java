...
public abstract class BaseHorizontalAnchorable implements HorizontalAnchorable {
    ...
    public final void mo5473linkToVpY3zN4(@NotNull final ConstraintLayoutBaseScope.HorizontalAnchor anchor, final float margin, final float goneMargin) {
        ...
        this.tasks.add(new Function1<State, Unit>() { // from class: androidx.constraintlayout.compose.BaseHorizontalAnchorable$linkTo$1
            ...
            public final void invoke(@NotNull State state) {
                ...
                ((ConstraintReference) horizontalAnchorFunctions[i][horizontalAnchor.getIndex$compose_release()].invoke(constraintReference, horizontalAnchor.getId$compose_release())).margin(C0856Dp.m5214boximpl(f)).marginGone(C0856Dp.m5214boximpl(f2));
            }
        });
    }
}
