...
/* renamed from: androidx.constraintlayout.compose.ConstraintLayoutBaseScope$createEndBarrier$1, reason: from Kotlin metadata and case insensitive filesystem */
/* loaded from: E:\ai\xiaomai1\gradle\app\src\main\classes2.dex */
final class C0020ConstraintLayoutBaseScope$createEndBarrier$1 extends Lambda implements Function1<State, Unit> {
    final /* synthetic */ ConstrainedLayoutReference[] $elements;
    final /* synthetic */ int $id;
    final /* synthetic */ float $margin;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    C0020ConstraintLayoutBaseScope$createEndBarrier$1(int i, float f, ConstrainedLayoutReference[] constrainedLayoutReferenceArr) {
        super(1);
        this.$id = i;
        this.$margin = f;
