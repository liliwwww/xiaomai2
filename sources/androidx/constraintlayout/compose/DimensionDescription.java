...
public final class DimensionDescription implements Dimension.Coercible, Dimension.MaxCoercible, Dimension.MinCoercible, Dimension {
    ...
    public DimensionDescription(@NotNull Function1<? super State, ? extends androidx.constraintlayout.core.state.Dimension> function1) {
    ...
    public final void m5530setMaxYLDhkOg(@Nullable C0856Dp c0856Dp) {
        this.max = c0856Dp;
    }
    ...
    public final void m5531setMinYLDhkOg(@Nullable C0856Dp c0856Dp) {
        this.min = c0856Dp;
    }
