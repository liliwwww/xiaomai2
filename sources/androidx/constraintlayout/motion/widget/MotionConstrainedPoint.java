...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f274x, this.f275y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
    ...
    public void setState(Rect rect, View view, int i, float f) {
        setBounds(rect.left, rect.top, com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(rect), com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(rect));
        applyParameters(view);
    ...
    void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f274x, motionConstrainedPoint.f274x);
        zArr[2] = zArr[2] | diff(this.f275y, motionConstrainedPoint.f275y);
