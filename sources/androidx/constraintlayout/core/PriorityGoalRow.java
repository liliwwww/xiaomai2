...
public class PriorityGoalRow extends ArrayRow {
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        if (i4 > 1 && solverVariableArr3[i4 - 1].id > solverVariable.id) {
            ...
            Arrays.sort(this.sortArray, 0, i, new 1(this));
    ...
    public void clear() {
        this.numGoals = 0;
        ((ArrayRow) this).constantValue = 0.0f;
    }
    ...
    public String toString() {
        String str = " goal -> (" + ((ArrayRow) this).constantValue + ") : ";
    ...
    public void updateFromRow(LinearSystem linearSystem, ArrayRow arrayRow, boolean z) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            ((ArrayRow) this).constantValue += arrayRow.constantValue * variableValue;
        }
