...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor {
        ...
        public void add(SolverVariable solverVariable) {
            for (int i = 0; i < 9; i++) {
                ...
                if (Math.abs(fArr[i]) < PriorityGoalRow.epsilon) {
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i4 - 1].f235id > solverVariable.f235id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.core.PriorityGoalRow.1
                ...
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f235id - solverVariable3.f235id;
                }
            });
