...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.getTextBounds(WVUtils.URL_DATA_CHAR, 0, 1, rect);
            canvas.drawText(WVUtils.URL_DATA_CHAR, ((width / 2.0f) - (com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(rect) / 2.0f)) - rect.left, ((height / 2.0f) + (com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(rect) / 2.0f)) - rect.bottom, paint);
        }
    }
