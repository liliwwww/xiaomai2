...
final class DefaultButtonElevation$elevation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    DefaultButtonElevation$elevation$2(Animatable<C0856Dp, AnimationVector1D> animatable, float f, Continuation<? super DefaultButtonElevation$elevation$2> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            C0856Dp m5214boximpl = C0856Dp.m5214boximpl(this.$target);
            this.label = 1;
            if (animatable.snapTo(m5214boximpl, this) == coroutine_suspended) {
