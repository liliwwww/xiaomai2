...
public final class FavoriteBorderKt {
    ...
    public static final androidx.compose.ui.graphics.vector.ImageVector getFavoriteBorder(@org.jetbrains.annotations.NotNull androidx.compose.material.icons.Icons$Rounded r29) {
        /*
            Method dump skipped, instructions count: 422
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.rounded.FavoriteBorderKt.getFavoriteBorder(androidx.compose.material.icons.Icons$Rounded):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
