...
public final class CheckKt {
    ...
    @NotNull
    public static final ImageVector getCheck(@NotNull Icons$Rounded icons$Rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Check", Dp.constructor-impl(24.0f), Dp.constructor-impl(24.0f), 24.0f, 24.0f, 0L, 0, 96, (DefaultConstructorMarker) null);
