...
public final class CreateKt {
    ...
    @NotNull
    public static final ImageVector getCreate(@NotNull Icons$Filled icons$Filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Create", Dp.constructor-impl(24.0f), Dp.constructor-impl(24.0f), 24.0f, 24.0f, 0L, 0, 96, (DefaultConstructorMarker) null);
