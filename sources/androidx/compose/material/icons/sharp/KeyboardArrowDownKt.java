...
public final class KeyboardArrowDownKt {
    ...
    @NotNull
    public static final ImageVector getKeyboardArrowDown(@NotNull Icons$Sharp icons$Sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.KeyboardArrowDown", Dp.constructor-impl(24.0f), Dp.constructor-impl(24.0f), 24.0f, 24.0f, 0L, 0, 96, (DefaultConstructorMarker) null);
