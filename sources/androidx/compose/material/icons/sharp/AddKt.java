...
public final class AddKt {
    ...
    @NotNull
    public static final ImageVector getAdd(@NotNull Icons$Sharp icons$Sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Add", Dp.constructor-impl(24.0f), Dp.constructor-impl(24.0f), 24.0f, 24.0f, 0L, 0, 96, (DefaultConstructorMarker) null);
