...
public final class KeyboardArrowUpKt {
    ...
    @NotNull
    public static final ImageVector getKeyboardArrowUp(@NotNull Icons$Sharp icons$Sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.KeyboardArrowUp", Dp.constructor-impl(24.0f), Dp.constructor-impl(24.0f), 24.0f, 24.0f, 0L, 0, 96, (DefaultConstructorMarker) null);
