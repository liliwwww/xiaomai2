...
final class BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    BottomSheetScaffoldKt$BottomSheetScaffold$1$child$1$1$1(Function2<? super Composer, ? super Integer, Unit> function2, int i, Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, float f, int i2) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        function3.invoke(PaddingKt.PaddingValues-a9UjIt4$default(0.0f, 0.0f, 0.0f, f, 7, (Object) null), composer, Integer.valueOf((i3 >> 3) & 112));
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endNode();
