...
final class ButtonKt$Button$2$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ButtonKt$Button$2$1$1(PaddingValues paddingValues, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i) {
        super(2);
    ...
    public final void invoke(@Nullable Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-630330208, i, -1, "androidx.compose.material.Button.<anonymous>.<anonymous>.<anonymous> (Button.kt:117)");
        }
        Modifier.Companion companion = Modifier.Companion;
        ButtonDefaults buttonDefaults = ButtonDefaults.INSTANCE;
        Modifier padding = PaddingKt.padding(SizeKt.defaultMinSize-VpY3zN4(companion, buttonDefaults.m531getMinWidthD9Ej5fM(), buttonDefaults.m530getMinHeightD9Ej5fM()), this.$contentPadding);
