...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4535calculateInverseMatrixbWbORWo(T t) {
        float[] fArr = this.inverseMatrixCache;
        if (fArr == null) {
            fArr = androidx.compose.p004ui.graphics.Matrix.m2982constructorimpl$default(null, 1, null);
            this.inverseMatrixCache = fArr;
        }
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4533invertToJiSxe2E(m4536calculateMatrixGrdbGEg(t), fArr);
    ...
    public final float[] m4536calculateMatrixGrdbGEg(T t) {
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m2669setFromtUYjHk(fArr, matrix);
