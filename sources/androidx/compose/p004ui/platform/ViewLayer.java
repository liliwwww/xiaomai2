...
public final class ViewLayer extends View implements GraphicLayerInfo, OwnedLayer {
    ...
    public ViewLayer(@NotNull AndroidComposeView androidComposeView, @NotNull DrawChildContainer drawChildContainer, @NotNull Function1<? super Canvas, Unit> function1, @NotNull Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m3130getCenterSzJe1aQ();
    ...
    @Override // android.view.View, androidx.compose.p004ui.node.OwnedLayer
    ...
    public void mo4439inverseTransform58bKbWc(@NotNull float[] fArr) {
        ...
        float[] m4535calculateInverseMatrixbWbORWo = this.matrixCache.m4535calculateInverseMatrixbWbORWo(this);
    ...
    public boolean mo4440isInLayerk4lQ0M(long j) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m2556getXimpl && m2556getXimpl < ((float) getWidth()) && 0.0f <= m2557getYimpl && m2557getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mapBounds(@NotNull MutableRect mutableRect, boolean z) {
        ...
        if (!z) {
            androidx.compose.p004ui.graphics.Matrix.m2990mapimpl(this.matrixCache.m4536calculateMatrixGrdbGEg(this), mutableRect);
            return;
        }
        float[] m4535calculateInverseMatrixbWbORWo = this.matrixCache.m4535calculateInverseMatrixbWbORWo(this);
        if (m4535calculateInverseMatrixbWbORWo != null) {
    ...
    public long mo4441mapOffset8S9VItk(long j, boolean z) {
        if (!z) {
            return androidx.compose.p004ui.graphics.Matrix.m2988mapMKHz9U(this.matrixCache.m4536calculateMatrixGrdbGEg(this), j);
        }
        float[] m4535calculateInverseMatrixbWbORWo = this.matrixCache.m4535calculateInverseMatrixbWbORWo(this);
    ...
    public void mo4442movegyyYBs(long j) {
        ...
        if (m5334getXimpl != getLeft()) {
            offsetLeftAndRight(m5334getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m5335getYimpl = IntOffset.m5335getYimpl(j);
        if (m5335getYimpl != getTop()) {
            offsetTopAndBottom(m5335getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public void mo4443resizeozmzZPI(long j) {
        ...
        if (m5376getWidthimpl == getWidth() && m5375getHeightimpl == getHeight()) {
            return;
        }
        float f = m5376getWidthimpl;
        setPivotX(TransformOrigin.m3125getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = m5375getHeightimpl;
        setPivotY(TransformOrigin.m3126getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m4560updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m5376getWidthimpl, getTop() + m5375getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4444transform58bKbWc(@NotNull float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        androidx.compose.p004ui.graphics.Matrix.m2999timesAssign58bKbWc(fArr, this.matrixCache.m4536calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo4445updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, @NotNull Shape shape, boolean z, @Nullable RenderEffect renderEffect, long j2, long j3, int i, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        setRotationX(f7);
        setRotationY(f8);
        setPivotX(TransformOrigin.m3125getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m3126getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        ...
        if (i2 >= 28) {
            ...
            viewLayerVerificationHelper28.setOutlineAmbientShadowColor(this, ColorKt.m2841toArgb8_81llA(j2));
            viewLayerVerificationHelper28.setOutlineSpotShadowColor(this, ColorKt.m2841toArgb8_81llA(j3));
        }
        if (i2 >= 31) {
