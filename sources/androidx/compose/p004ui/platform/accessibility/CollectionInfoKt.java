...
import androidx.compose.p004ui.semantics.CollectionItemInfo;
...
public final class CollectionInfoKt {
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m2545boximpl(OffsetKt.Offset(Math.abs(Offset.m2556getXimpl(semanticsNode4.getBoundsInRoot().m2586getCenterF1C5BW0()) - Offset.m2556getXimpl(semanticsNode3.getBoundsInRoot().m2586getCenterF1C5BW0())), Math.abs(Offset.m2557getYimpl(semanticsNode4.getBoundsInRoot().m2586getCenterF1C5BW0()) - Offset.m2557getYimpl(semanticsNode3.getBoundsInRoot().m2586getCenterF1C5BW0())))));
                semanticsNode = semanticsNode2;
            }
        }
        if (emptyList.size() == 1) {
            m2566unboximpl = ((Offset) CollectionsKt.first(emptyList)).m2566unboximpl();
        } else {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m2545boximpl(Offset.m2561plusMKHz9U(((Offset) first).m2566unboximpl(), ((Offset) emptyList.get(i2)).m2566unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            m2566unboximpl = ((Offset) first).m2566unboximpl();
        }
        return Offset.m2547component2impl(m2566unboximpl) < Offset.m2546component1impl(m2566unboximpl);
    }
        ...
        if ((collectionInfo == null || !isLazyCollection(collectionInfo)) && semanticsNode.getConfig().contains(semanticsProperties.getSelected())) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                AccessibilityNodeInfoCompat.CollectionItemInfoCompat obtain = AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(calculateIfHorizontallyStacked ? 0 : i, 1, calculateIfHorizontallyStacked ? i : 0, 1, false, ((Boolean) semanticsNode.getConfig().getOrElse(SemanticsProperties.INSTANCE.getSelected(), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.accessibility.CollectionInfoKt$setCollectionItemInfo$itemInfo$1
                    ...
                    public final Boolean m4572invoke() {
    ...
    private static final AccessibilityNodeInfoCompat.CollectionItemInfoCompat toAccessibilityCollectionItemInfo(CollectionItemInfo collectionItemInfo, SemanticsNode semanticsNode) {
        return AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(collectionItemInfo.getRowIndex(), collectionItemInfo.getRowSpan(), collectionItemInfo.getColumnIndex(), collectionItemInfo.getColumnSpan(), false, ((Boolean) semanticsNode.getConfig().getOrElse(SemanticsProperties.INSTANCE.getSelected(), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.accessibility.CollectionInfoKt$toAccessibilityCollectionItemInfo$1
            @NotNull
            /* renamed from: invoke, reason: merged with bridge method [inline-methods] */
            public final Boolean m4573invoke() {
                return Boolean.FALSE;
            }
        })).booleanValue());
    }
