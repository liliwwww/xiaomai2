    ...
    public static final boolean excludeLineAndPageGranularities(SemanticsNode semanticsNode) {
        ...
        LayoutNode findClosestParentNode = findClosestParentNode(semanticsNode.getLayoutNode$ui_release(), new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat_androidKt$excludeLineAndPageGranularities$ancestor$1
            ...
            public final Boolean invoke(@NotNull LayoutNode layoutNode) {
                ...
                return Boolean.valueOf((collapsedSemanticsConfiguration2 != null && collapsedSemanticsConfiguration2.isMergingSemanticsOfDescendants()) && collapsedSemanticsConfiguration2.contains(SemanticsActions.INSTANCE.getSetText()));
            }
        });
        ...
        if (!region.isEmpty() || semanticsNode2.getId() == semanticsNode.getId()) {
            if (!z2 || semanticsNode2.isFake$ui_release()) {
                ...
                if (semanticsNode2.isFake$ui_release()) {
                    ...
                    map.put(Integer.valueOf(id), new SemanticsNodeWithAdjustedBounds(semanticsNode2, RectHelper_androidKt.toAndroidRect(z ? parent.getBoundsInRoot() : new androidx.compose.p004ui.geometry.Rect(0.0f, 0.0f, 10.0f, 10.0f))));
                    return;
                }
                if (id == -1) {
