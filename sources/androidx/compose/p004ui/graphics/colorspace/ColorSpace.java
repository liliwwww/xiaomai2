...
public abstract class ColorSpace {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f111id == colorSpace.f111id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m3146equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }
    ...
    public final float[] fromXyz(float f, float f2, float f3) {
        float[] fArr = new float[ColorModel.m3147getComponentCountimpl(this.model)];
        fArr[0] = f;
        fArr[1] = f2;
        fArr[2] = f3;
        return fromXyz(fArr);
    ...
    public final int getComponentCount() {
        return ColorModel.m3147getComponentCountimpl(this.model);
    }
    ...
    public final long m3155getModelxdoWZVw() {
        return this.model;
    }
    ...
    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m3148hashCodeimpl(this.model)) * 31) + this.f111id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.f111id + ", model=" + ((Object) ColorModel.m3149toStringimpl(this.model)) + ')';
    }
