...
public final class PathComponent extends VNode {
    ...
    public PathComponent() {
        ...
        this.pathMeasure$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, new Function0<PathMeasure>() { // from class: androidx.compose.ui.graphics.vector.PathComponent$pathMeasure$2
            @NotNull
            /* renamed from: invoke, reason: merged with bridge method [inline-methods] */
            public final PathMeasure m3320invoke() {
    ...
    public final int m3314getPathFillTypeRgk1Os() {
    ...
    public final int m3315getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8, reason: not valid java name */
    public final int m3316getStrokeLineJoinLxFBmk8() {
    ...
    public final void m3317setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo2691setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m3318setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m3319setStrokeLineJoinWw9F2mQ(int i) {
