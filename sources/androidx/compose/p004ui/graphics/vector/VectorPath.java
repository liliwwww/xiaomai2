...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(this.strokeLineWidth == vectorPath.strokeLineWidth) || !StrokeCap.m3088equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) || !StrokeJoin.m3098equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
            return false;
        }
        ...
        if (this.trimPathEnd == vectorPath.trimPathEnd) {
            return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m3026equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
        }
        return false;
    }
    ...
    public final int m3334getPathFillTypeRgk1Os() {
    ...
    public final int m3335getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8, reason: not valid java name */
    public final int m3336getStrokeLineJoinLxFBmk8() {
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((hashCode2 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.floatToIntBits(this.strokeAlpha)) * 31) + Float.floatToIntBits(this.strokeLineWidth)) * 31) + StrokeCap.m3089hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m3099hashCodeimpl(this.strokeLineJoin)) * 31) + Float.floatToIntBits(this.strokeLineMiter)) * 31) + Float.floatToIntBits(this.trimPathStart)) * 31) + Float.floatToIntBits(this.trimPathEnd)) * 31) + Float.floatToIntBits(this.trimPathOffset)) * 31) + PathFillType.m3027hashCodeimpl(this.pathFillType);
    }
