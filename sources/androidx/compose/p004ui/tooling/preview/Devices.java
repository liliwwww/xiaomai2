...
public final class Devices {
    ...
    @NotNull
    public static final String DESKTOP = "spec:shape=Normal,width=1920,height=1080,unit=dp,dpi=420";

    @NotNull
    public static final String FOLDABLE = "spec:shape=Normal,width=673,height=841,unit=dp,dpi=480";
    ...
    @NotNull
    public static final String TABLET = "spec:shape=Normal,width=1280,height=800,unit=dp,dpi=420";
