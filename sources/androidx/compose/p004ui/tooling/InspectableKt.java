...
public final class InspectableKt {
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final void Inspectable(@NotNull final CompositionDataRecord compositionDataRecord, @NotNull final Function2<? super Composer, ? super Integer, Unit> function2, @Nullable Composer composer, final int i) {
        int i2;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.InspectableKt$Inspectable$1
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                InspectableKt.Inspectable(CompositionDataRecord.this, function2, composer2, i | 1);
            }
        });
    }
}
