...
import androidx.compose.p004ui.platform.ViewRootForTest;
...
import androidx.compose.p004ui.tooling.animation.PreviewAnimationClock;
...
import androidx.compose.p004ui.tooling.data.SlotTreeKt;
import androidx.compose.p004ui.tooling.data.SourceLocation;
...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    private final class AnimateXAsStateSearch extends Search<Animatable<?, ?>> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnimateXAsStateSearch(@NotNull ComposeViewAdapter composeViewAdapter, Function1<Object, Unit> function1) {
            super(function1);
            Intrinsics.checkNotNullParameter(function1, "trackAnimation");
        ...
        public void parse(@NotNull Collection<? extends Group> collection) {
            ...
            while (it.hasNext()) {
                ...
                while (it2.hasNext()) {
                    Group firstOrNull = composeViewAdapter.firstOrNull((Group) it2.next(), ComposeViewAdapter$findRememberCall$rememberCalls$1$1.INSTANCE);
                    if (firstOrNull != null) {
    ...
    private final class AnimatedContentSearch extends Search<Transition<Object>> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnimatedContentSearch(@NotNull ComposeViewAdapter composeViewAdapter, Function1<Object, Unit> function1) {
            super(function1);
            Intrinsics.checkNotNullParameter(function1, "trackAnimation");
            this.this$0 = composeViewAdapter;
        }
        ...
        public void parse(@NotNull Collection<? extends Group> collection) {
            ...
            ArrayList arrayList = new ArrayList();
            for (Object obj2 : collection) {
                if (Intrinsics.areEqual(((Group) obj2).getName(), "AnimatedContent")) {
                    arrayList.add(obj2);
                }
            }
            ArrayList arrayList2 = new ArrayList();
            ...
            while (it3.hasNext()) {
                Group firstOrNull = composeViewAdapter.firstOrNull((Group) it3.next(), ComposeViewAdapter$findRememberCall$rememberCalls$1$1.INSTANCE);
                if (firstOrNull != null) {
                    arrayList3.add(firstOrNull);
                }
            }
    ...
    private final class AnimatedVisibilitySearch extends Search<Transition<Object>> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnimatedVisibilitySearch(@NotNull ComposeViewAdapter composeViewAdapter, Function1<Object, Unit> function1) {
            super(function1);
            Intrinsics.checkNotNullParameter(function1, "trackAnimation");
            this.this$0 = composeViewAdapter;
        }
    ...
    private static class Search<T> {
        ...
        public Search(@NotNull Function1<Object, Unit> function1) {
            Intrinsics.checkNotNullParameter(function1, "trackAnimation");
    ...
    private final class TransitionSearch extends Search<Transition<Object>> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public TransitionSearch(@NotNull ComposeViewAdapter composeViewAdapter, Function1<Object, Unit> function1) {
            super(function1);
            Intrinsics.checkNotNullParameter(function1, "trackAnimation");
            this.this$0 = composeViewAdapter;
        }
        ...
        public void parse(@NotNull Collection<? extends Group> collection) {
            ...
            Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                Group firstOrNull = composeViewAdapter.firstOrNull((Group) it.next(), ComposeViewAdapter$findRememberCall$rememberCalls$1$1.INSTANCE);
                if (firstOrNull != null) {
    ...
    public ComposeViewAdapter(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        this.previewComposition = ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5132getLambda2$ui_tooling_release();
        ...
        paint.setColor(ColorKt.m2841toArgb8_81llA(Color.Companion.m2821getRed0d7_KjU()));
        ...
        this.FakeActivityResultRegistryOwner = new ActivityResultRegistryOwner() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1
            ...
            @NotNull
            private final C0846x466dc6c4 activityResultRegistry = new ActivityResultRegistry() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1$activityResultRegistry$1
    ...
    private final void findAndTrackAnimations() {
        ...
        TransitionSearch transitionSearch = new TransitionSearch(this, new Function1<Object, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$findAndTrackAnimations$transitionSearch$1
            ...
            public final void m5143invoke(@NotNull Object obj) {
        ...
        AnimatedContentSearch animatedContentSearch = new AnimatedContentSearch(this, new Function1<Object, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$findAndTrackAnimations$animatedContentSearch$1
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5135invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
                ComposeViewAdapter.this.getClock$ui_tooling_release().trackAnimatedContent((Transition) obj);
            }
        });
        AnimatedVisibilitySearch animatedVisibilitySearch = new AnimatedVisibilitySearch(this, new Function1<Object, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$findAndTrackAnimations$animatedVisibilitySearch$1
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5136invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
                ComposeViewAdapter.this.getClock$ui_tooling_release().trackAnimatedVisibility((Transition) obj, new AnonymousClass1(ComposeViewAdapter.this));
            }
        });
        boolean z = false;
        Set plus = SetsKt.plus(SetsKt.setOf(new Search[]{transitionSearch, animatedVisibilitySearch}), UnsupportedComposeAnimation.Companion.getApiAvailable() ? SetsKt.setOf(new Search[]{animatedContentSearch, new AnimateXAsStateSearch(this, new Function1<Object, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$findAndTrackAnimations$extraSearch$1
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5138invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5139invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5140invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5141invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
            ...
            /* renamed from: invoke, reason: collision with other method in class */
            public final void m5142invoke(@NotNull Object obj) {
                Intrinsics.checkNotNullParameter(obj, "it");
    ...
    private final void findDesignInfoProviders() {
        ...
        while (it2.hasNext()) {
            List<Group> findAll = findAll((Group) it2.next(), new Function1<Group, Boolean>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$findDesignInfoProviders$1$1
                ...
                */
                public final java.lang.Boolean invoke(@org.jetbrains.annotations.NotNull androidx.compose.p004ui.tooling.data.Group r7) {
                    /*
                        r6 = this;
                        java.lang.String r0 = "group"
                        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r7, r0)
                        java.util.Collection r7 = r7.getChildren()
                        androidx.compose.ui.tooling.ComposeViewAdapter r0 = androidx.compose.p004ui.tooling.ComposeViewAdapter.this
                    ...
                    L1d:
                        ...
                        androidx.compose.ui.tooling.data.Group r1 = (androidx.compose.p004ui.tooling.data.Group) r1
                    ...
                    L4a:
                        ...
                        if (r4 == 0) goto L5b
                        java.lang.reflect.Method r4 = androidx.compose.p004ui.tooling.ComposeViewAdapter.access$getDesignInfoMethodOrNull(r0, r4)
                        goto L5c
                    L5b:
                        r4 = 0
                    L5c:
                    ...
                    L6b:
                        ...
                        return r7
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p004ui.tooling.ComposeViewAdapter$findDesignInfoProviders$1$1.invoke(androidx.compose.ui.tooling.data.Group):java.lang.Boolean");
                }
            });
            ArrayList arrayList3 = new ArrayList();
    ...
    private final /* synthetic */ <T> List<T> findRememberCall(Collection<? extends Group> collection) {
        ...
        while (it.hasNext()) {
            Group firstOrNull = firstOrNull((Group) it.next(), ComposeViewAdapter$findRememberCall$rememberCalls$1$1.INSTANCE);
            if (firstOrNull != null) {
    ...
    private final void invalidateComposition() {
        this.content.setValue(ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5133getLambda3$ui_tooling_release());
    ...
    @VisibleForTesting
    public final void init$ui_tooling_release(@NotNull final String str, @NotNull final String str2, @Nullable final Class<? extends PreviewParameterProvider<?>> cls, final int i, boolean z, boolean z2, final long j, boolean z3, boolean z4, @Nullable String str3, @NotNull final Function0<Unit> function0, @NotNull Function0<Unit> function02) {
        ...
        ComposableLambda composableLambdaInstance = ComposableLambdaKt.composableLambdaInstance(-1704541905, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$init$3
            ...
            public final void invoke(@Nullable Composer composer, int i2) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1704541905, i2, -1, "androidx.compose.ui.tooling.ComposeViewAdapter.init.<anonymous> (ComposeViewAdapter.kt:700)");
                }
                ...
                composeViewAdapter.WrapPreview(ComposableLambdaKt.composableLambda(composer, 1938351266, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$init$3.1
                    ...
                    @Composable
                    public final void invoke(@Nullable final Composer composer2, int i4) {
                        if ((i4 & 11) == 2 && composer2.getSkipping()) {
                            composer2.skipToGroupEnd();
                            return;
                        }
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1938351266, i4, -1, "androidx.compose.ui.tooling.ComposeViewAdapter.init.<anonymous>.<anonymous> (ComposeViewAdapter.kt:703)");
                        }
                        ...
                        Function0<Unit> function03 = new Function0<Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$init$3$1$composable$1
                            ...
                            public final void m5147invoke() {
                                ...
                                try {
                                    ...
                                    Object[] previewProviderParameters = PreviewUtilsKt.getPreviewProviderParameters(cls3, i5);
                                    composableInvoker.invokeComposable(str8, str9, composer3, Arrays.copyOf(previewProviderParameters, previewProviderParameters.length));
                                } catch (Throwable th) {
                                    Throwable th2 = th;
