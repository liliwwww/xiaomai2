...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2450alignKFBX0sM(long j, long j2, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m5376getWidthimpl(j2) - IntSize.m5376getWidthimpl(j), IntSize.m5375getHeightimpl(j2) - IntSize.m5375getHeightimpl(j));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5376getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5375getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
