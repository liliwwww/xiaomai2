...
public final class DepthSortedSet {
    ...
    public DepthSortedSet(boolean z) {
        ...
        this.mapOfOriginalDepth$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, new Function0<Map<LayoutNode, Integer>>() { // from class: androidx.compose.ui.node.DepthSortedSet$mapOfOriginalDepth$2
            @NotNull
