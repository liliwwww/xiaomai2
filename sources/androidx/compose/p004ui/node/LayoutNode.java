...
import androidx.compose.p004ui.platform.JvmActuals_jvmKt;
...
public final class LayoutNode implements LayoutInfo, Remeasurement, ComposeUiNode, Owner.OnLayoutCompletedListener, OwnerScope {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo944measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m4318measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        @NotNull
        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m4318measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull List<? extends Measurable> list, long j) {
    ...
    private static final Function0<LayoutNode> Constructor = new Function0<LayoutNode>() { // from class: androidx.compose.ui.node.LayoutNode$Companion$Constructor$1
        ...
        public final LayoutNode m4316invoke() {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4317getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.Companion.m5324getZeroMYxV2XQ();
        }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4319maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.p004ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4320maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.p004ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4321minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.p004ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4322minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @NotNull
        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m4319maxIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> list, int i) {
        ...
        public Void m4320maxIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> list, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(list, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        public Void m4321minIntrinsicHeight(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> list, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(list, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        public Void m4322minIntrinsicWidth(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull List<? extends IntrinsicMeasurable> list, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(list, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m4398constructorimpl(1024) | NodeKind.m4398constructorimpl(2048) | NodeKind.m4398constructorimpl(4096))) {
            for (Modifier.Node head$ui_release = this.nodes.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if (((NodeKind.m4398constructorimpl(1024) & head$ui_release.getKindSet$ui_release()) != 0) | ((NodeKind.m4398constructorimpl(2048) & head$ui_release.getKindSet$ui_release()) != 0) | ((NodeKind.m4398constructorimpl(4096) & head$ui_release.getKindSet$ui_release()) != 0)) {
    ...
    private final void invalidateFocusOnDetach() {
        if (this.nodes.m4356hasH91voCI$ui_release(NodeKind.m4398constructorimpl(1024))) {
            for (Modifier.Node tail$ui_release = this.nodes.getTail$ui_release(); tail$ui_release != null; tail$ui_release = tail$ui_release.getParent$ui_release()) {
                if (((NodeKind.m4398constructorimpl(1024) & tail$ui_release.getKindSet$ui_release()) != 0) && (tail$ui_release instanceof FocusTargetModifierNode)) {
    ...
    public static /* synthetic */ boolean m4310lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4330getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4314lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    public static /* synthetic */ boolean m4311remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4329getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4315remeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4356hasH91voCI$ui_release(NodeKind.m4398constructorimpl(4)) && !this.nodes.m4356hasH91voCI$ui_release(NodeKind.m4398constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head$ui_release = this.nodes.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
            if (((NodeKind.m4398constructorimpl(2) & head$ui_release.getKindSet$ui_release()) != 0) && (head$ui_release instanceof LayoutModifierNode) && DelegatableNodeKt.m4288requireCoordinator64DMado(head$ui_release, NodeKind.m4398constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m4398constructorimpl(4) & head$ui_release.getKindSet$ui_release()) != 0) {
                return true;
            }
        }
        return true;
    ...
    */
    public final void attach$ui_release(@org.jetbrains.annotations.NotNull androidx.compose.p004ui.node.Owner r7) {
        /*
            Method dump skipped, instructions count: 282
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p004ui.node.LayoutNode.attach$ui_release(androidx.compose.ui.node.Owner):void");
    }
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        int m4398constructorimpl = NodeKind.m4398constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & m4398constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & m4398constructorimpl) != 0 && (head$ui_release instanceof GlobalPositionAwareModifierNode)) {
                    GlobalPositionAwareModifierNode globalPositionAwareModifierNode = (GlobalPositionAwareModifierNode) head$ui_release;
                    globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m4288requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m4398constructorimpl(256)));
                }
                if ((head$ui_release.getAggregateChildKindSet$ui_release() & m4398constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public void forceRemeasure() {
        ...
        Constraints m4329getLastConstraintsDWUhwKw = this.layoutDelegate.m4329getLastConstraintsDWUhwKw();
        if (m4329getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4449measureAndLayout0kLqBqw(this, m4329getLastConstraintsDWUhwKw.m5190unboximpl());
                return;
            }
            return;
        }
    ...
    @Override // androidx.compose.p004ui.layout.LayoutInfo
    @NotNull
    public LayoutCoordinates getCoordinates() {
        return getInnerCoordinator$ui_release();
    }

    @Override // androidx.compose.p004ui.layout.LayoutInfo, androidx.compose.p004ui.node.ComposeUiNode
    @NotNull
    ...
    @Override // androidx.compose.p004ui.node.ComposeUiNode
    @NotNull
    ...
    public final void m4312hitTestM_7yMNQ$ui_release(long j, @NotNull HitTestResult<PointerInputModifierNode> hitTestResult, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        getOuterCoordinator$ui_release().m4380hitTestYqVAtuI(NodeCoordinator.Companion.getPointerInputSource(), getOuterCoordinator$ui_release().m4375fromParentPositionMKHz9U(j), hitTestResult, z, z2);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4313hitTestSemanticsM_7yMNQ$ui_release(long j, @NotNull HitTestResult<SemanticsModifierNode> hitTestResult, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitSemanticsEntities");
        getOuterCoordinator$ui_release().m4380hitTestYqVAtuI(NodeCoordinator.Companion.getSemanticsSource(), getOuterCoordinator$ui_release().m4375fromParentPositionMKHz9U(j), hitTestResult, true, z2);
    }
    ...
    public final void invalidateSubtree(boolean z) {
        ...
        if ((nodeChain.getAggregateChildKindSet() & m4398constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & m4398constructorimpl) != 0 && (head$ui_release instanceof LayoutModifierNode) && (layer = DelegatableNodeKt.m4288requireCoordinator64DMado((LayoutModifierNode) head$ui_release, NodeKind.m4398constructorimpl(2)).getLayer()) != null) {
                    layer.invalidate();
                }
                if ((head$ui_release.getAggregateChildKindSet$ui_release() & m4398constructorimpl) == 0) {
                    break;
    ...
    public final boolean m4314lookaheadRemeasure_Sx5XlM$ui_release(@Nullable Constraints constraints) {
        if (constraints == null || this.mLookaheadScope == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate = getLookaheadPassDelegate();
        Intrinsics.checkNotNull(lookaheadPassDelegate);
        return lookaheadPassDelegate.m4332remeasureBRTryo0(constraints.m5190unboximpl());
    }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node headNode = innerCoordinator$ui_release.headNode(m4406getIncludeSelfInTraversalH91voCI); headNode != null && (headNode.getAggregateChildKindSet$ui_release() & m4398constructorimpl) != 0; headNode = headNode.getChild$ui_release()) {
    ...
    public final boolean m4315remeasure_Sx5XlM$ui_release(@Nullable Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate().m4337remeasureBRTryo0(constraints.m5190unboximpl());
    }
