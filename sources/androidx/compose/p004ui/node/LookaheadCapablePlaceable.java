...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode {
    ...
    public final int get(@NotNull AlignmentLine alignmentLine) {
        ...
        if (getHasMeasureResult() && (calculateAlignmentLine = calculateAlignmentLine(alignmentLine)) != Integer.MIN_VALUE) {
            return calculateAlignmentLine + (alignmentLine instanceof VerticalAlignmentLine ? IntOffset.m5334getXimpl(m4218getApparentToRealOffsetnOccac()) : IntOffset.m5335getYimpl(m4218getApparentToRealOffsetnOccac()));
        }
    ...
    @Override // androidx.compose.p004ui.node.MeasureScopeWithLayoutNode
    @NotNull
    ...
    public abstract long mo4342getPositionnOccac();
