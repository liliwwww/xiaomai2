...
public final class MeasureAndLayoutDelegate {
    ...
    private final boolean m4347doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        if (layoutNode.getMLookaheadScope$ui_release() == null) {
            return false;
        }
        boolean m4314lookaheadRemeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m4314lookaheadRemeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m4310lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4314lookaheadRemeasure_Sx5XlM$ui_release && parent$ui_release != null) {
        ...
        return m4314lookaheadRemeasure_Sx5XlM$ui_release;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m4348doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4315remeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m4315remeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m4311remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4315remeasure_Sx5XlM$ui_release && parent$ui_release != null) {
        ...
        return m4315remeasure_Sx5XlM$ui_release;
    }
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode) {
        ...
        boolean m4347doLookaheadRemeasuresdFAvZA;
        boolean m4348doRemeasuresdFAvZA;
        int i = 0;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            m4347doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m4347doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            m4348doRemeasuresdFAvZA = m4348doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4348doRemeasuresdFAvZA = false;
            m4347doLookaheadRemeasuresdFAvZA = false;
        }
        if ((m4347doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE)) {
        ...
        return m4348doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m4347doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m4348doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    public final void m4349measureAndLayout0kLqBqw(@NotNull LayoutNode layoutNode, long j) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean m4347doLookaheadRemeasuresdFAvZA = m4347doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m5172boximpl(j));
                m4348doRemeasuresdFAvZA(layoutNode, Constraints.m5172boximpl(j));
                if ((m4347doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
    ...
    public final void m4350updateRootConstraintsBRTryo0(long j) {
        ...
        this.rootConstraints = Constraints.m5172boximpl(j);
