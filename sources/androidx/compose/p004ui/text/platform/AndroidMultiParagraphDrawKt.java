...
import androidx.compose.p004ui.text.ParagraphInfo;
...
public final class AndroidMultiParagraphDrawKt {
    public static final void drawMultiParagraph(@NotNull MultiParagraph multiParagraph, @NotNull Canvas canvas, @NotNull Brush brush, float f, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle) {
        ...
        if (multiParagraph.getParagraphInfoList$ui_text_release().size() <= 1) {
            ...
            Shader mo2762createShaderuvyYCjk = ((ShaderBrush) brush).mo2762createShaderuvyYCjk(SizeKt.Size(f2, f3));
            Matrix matrix = new Matrix();
            mo2762createShaderuvyYCjk.getLocalMatrix(matrix);
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                paragraphInfo2.getParagraph().paint(canvas, BrushKt.ShaderBrush(mo2762createShaderuvyYCjk), f, shadow, textDecoration, drawStyle);
                ...
                mo2762createShaderuvyYCjk.setLocalMatrix(matrix);
            }
        }
        canvas.restore();
    }
