...
final class FontListFontFamilyTypefaceAdapter$preload$3$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
    ...
    static final class C08441 extends SuspendLambda implements Function1<Continuation<? super Object>, Object> {
        final /* synthetic */ Font $font;
        final /* synthetic */ PlatformFontLoader $resourceLoader;
        int label;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08441(Font font, PlatformFontLoader platformFontLoader, Continuation<? super C08441> continuation) {
        ...
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C08441(this.$font, this.$resourceLoader, continuation);
        }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            Font font = this.$font;
            PlatformFontLoader platformFontLoader = this.$resourceLoader;
            C08441 c08441 = new C08441(font, platformFontLoader, null);
            this.label = 1;
            obj = asyncTypefaceCache.runCached(font, platformFontLoader, true, c08441, this);
            if (obj == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
