...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    @NotNull
    private static final CoroutineExceptionHandler DropExceptionHandler = new C0843x6d95c97a(CoroutineExceptionHandler.Key);
    ...
    */
    public FontListFontFamilyTypefaceAdapter() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p004ui.text.font.FontListFontFamilyTypefaceAdapter.<init>():void");
    }
    ...
    public final Object preload(@NotNull FontFamily fontFamily, @NotNull PlatformFontLoader platformFontLoader, @NotNull Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m4821equalsimpl0(font.mo4780getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m4825getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList2.add(TuplesKt.to(font2.getWeight(), FontStyle.m4831boximpl(font2.mo4790getStyle_LCdwA())));
        }
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            ...
            int m4837unboximpl = ((FontStyle) pair.component2()).m4837unboximpl();
            firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m4830matchFontRetOiIg(fonts, fontWeight, m4837unboximpl), new TypefaceRequest(fontFamily, fontWeight, m4837unboximpl, FontSynthesis.Companion.m4849getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(@NotNull TypefaceRequest typefaceRequest, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function1<? super TypefaceResult.Immutable, Unit> function1, @NotNull Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m4830matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m4875getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, function12);
        List list = (List) firstImmediatelyAvailable.component1();
        ...
        d.d(this.asyncLoadScope, (CoroutineContext) null, CoroutineStart.UNDISPATCHED, new FontListFontFamilyTypefaceAdapter$resolve$1(asyncFontListLoader, null), 1, (Object) null);
