...
public final class AnnotatedString implements CharSequence {
    ...
    public static final class Builder implements Appendable {
        ...
        public final void append(@NotNull AnnotatedString annotatedString, int i, int i2) {
            List localSpanStyles;
            List localParagraphStyles;
            List localAnnotations;
            Intrinsics.checkNotNullParameter(annotatedString, "text");
            int length = this.text.length();
            this.text.append((CharSequence) annotatedString.getText(), i, i2);
            localSpanStyles = AnnotatedStringKt.getLocalSpanStyles(annotatedString, i, i2);
            ...
            localParagraphStyles = AnnotatedStringKt.getLocalParagraphStyles(annotatedString, i, i2);
            ...
            localAnnotations = AnnotatedStringKt.getLocalAnnotations(annotatedString, i, i2);
    ...
    public final AnnotatedString m4622subSequence5zctL8(long j) {
        return subSequence(TextRange.m4747getMinimpl(j), TextRange.m4746getMaximpl(j));
    }
