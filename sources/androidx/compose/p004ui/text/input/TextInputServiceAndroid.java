...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(@NotNull View view, @NotNull InputMethodManager inputMethodManager) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                m4959invokeKlQnJC8(((ImeAction) obj).m4886unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m4959invokeKlQnJC8(int i) {
            }
        };
        this.state = new TextFieldValue("", TextRange.Companion.m4754getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
        ...
        this.baseInputConnection$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, new Function0<BaseInputConnection>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$baseInputConnection$2
            ...
            public final BaseInputConnection m4958invoke() {
    ...
    public final InputConnection createInputConnection(@NotNull EditorInfo editorInfo) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
            @Override // androidx.compose.p004ui.text.input.InputEventCallback2
            ...
            public void mo4909onImeActionKlQnJC8(int i) {
                Function1 function1;
                function1 = TextInputServiceAndroid.this.onImeActionPerformed;
                function1.invoke(ImeAction.m4880boximpl(i));
            }
    ...
    @Override // androidx.compose.p004ui.text.input.PlatformTextInputService
    ...
    public void notifyFocusedRect(@NotNull androidx.compose.p004ui.geometry.Rect rect) {
        Rect rect2;
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$stopInput$2
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                m4960invokeKlQnJC8(((ImeAction) obj).m4886unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m4960invokeKlQnJC8(int i) {
            }
        };
    ...
    */
    public final java.lang.Object textInputCommandEventLoop(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        ...
        Lbd:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p004ui.text.input.TextInputServiceAndroid.textInputCommandEventLoop(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public void updateState(@Nullable TextFieldValue textFieldValue, @NotNull TextFieldValue textFieldValue2) {
        ...
        boolean z = true;
        boolean z2 = (TextRange.m4742equalsimpl0(this.state.m4956getSelectiond9O1mEE(), textFieldValue2.m4956getSelectiond9O1mEE()) && Intrinsics.areEqual(this.state.m4955getCompositionMzsxiRA(), textFieldValue2.m4955getCompositionMzsxiRA())) ? false : true;
        ...
        if (Intrinsics.areEqual(textFieldValue, textFieldValue2)) {
            if (z2) {
                ...
                int m4747getMinimpl = TextRange.m4747getMinimpl(textFieldValue2.m4956getSelectiond9O1mEE());
                int m4746getMaximpl = TextRange.m4746getMaximpl(textFieldValue2.m4956getSelectiond9O1mEE());
                TextRange m4955getCompositionMzsxiRA = this.state.m4955getCompositionMzsxiRA();
                ...
                TextRange m4955getCompositionMzsxiRA2 = this.state.m4955getCompositionMzsxiRA();
                inputMethodManager.updateSelection(m4747getMinimpl, m4746getMaximpl, m4747getMinimpl2, m4955getCompositionMzsxiRA2 != null ? TextRange.m4746getMaximpl(m4955getCompositionMzsxiRA2.m4753unboximpl()) : -1);
                return;
            }
            return;
        }
        if (textFieldValue == null || (Intrinsics.areEqual(textFieldValue.getText(), textFieldValue2.getText()) && (!TextRange.m4742equalsimpl0(textFieldValue.m4956getSelectiond9O1mEE(), textFieldValue2.m4956getSelectiond9O1mEE()) || Intrinsics.areEqual(textFieldValue.m4955getCompositionMzsxiRA(), textFieldValue2.m4955getCompositionMzsxiRA())))) {
            z = false;
        }
        if (z) {
