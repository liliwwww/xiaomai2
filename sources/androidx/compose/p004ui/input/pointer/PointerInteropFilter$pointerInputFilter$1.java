...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
        ...
        if (z) {
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                ...
                long mo4193localToRootMKHz9U = layoutCoordinates$ui_release.mo4193localToRootMKHz9U(Offset.Companion.m2572getZeroF1C5BW0());
                final PointerInteropFilter pointerInteropFilter = this.this$0;
                PointerInteropUtils_androidKt.m4126toCancelMotionEventScoped4ec7I(pointerEvent, mo4193localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                    {
                        super(1);
                    }
        ...
        long mo4193localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo4193localToRootMKHz9U(Offset.Companion.m2572getZeroF1C5BW0());
        final PointerInteropFilter pointerInteropFilter2 = this.this$0;
        PointerInteropUtils_androidKt.m4127toMotionEventScoped4ec7I(pointerEvent, mo4193localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
    ...
    */
    public void mo4102onPointerEventH0pRuoY(@org.jetbrains.annotations.NotNull androidx.compose.p004ui.input.pointer.PointerEvent r6, @org.jetbrains.annotations.NotNull androidx.compose.p004ui.input.pointer.PointerEventPass r7, long r8) {
        /*
            r5 = this;
        ...
        L1f:
            ...
            androidx.compose.ui.input.pointer.PointerInputChange r3 = (androidx.compose.p004ui.input.pointer.PointerInputChange) r3
            boolean r4 = androidx.compose.p004ui.input.pointer.PointerEventKt.changedToDownIgnoreConsumed(r3)
            if (r4 != 0) goto L36
            boolean r3 = androidx.compose.p004ui.input.pointer.PointerEventKt.changedToUpIgnoreConsumed(r3)
            if (r3 == 0) goto L34
            goto L36
        L34:
            r3 = 0
        ...
        L66:
            ...
            boolean r9 = androidx.compose.p004ui.input.pointer.PointerEventKt.changedToUpIgnoreConsumed(r9)
            if (r9 != 0) goto L75
            goto L79
        L75:
            int r7 = r7 + 1
        ...
        L7e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.p004ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo4102onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
}
