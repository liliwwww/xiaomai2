...
public final class BiasAlignment implements Alignment {
    ...
    public long m811alignKFBX0sM(long j, long j2, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float f = (IntSize.getWidth-impl(j2) - IntSize.getWidth-impl(j)) / 2.0f;
        float f2 = (IntSize.getHeight-impl(j2) - IntSize.getHeight-impl(j)) / 2.0f;
        float f3 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(f * ((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias) + f3)), MathKt.roundToInt(f2 * (f3 + this.verticalBias)));
    }
