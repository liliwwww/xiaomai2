...
public abstract class AlignmentLines {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = mo2091calculatePositionInParentR5De75A(nodeCoordinator, Offset);
        ...
        int roundToInt = alignmentLine instanceof HorizontalAlignmentLine ? MathKt.roundToInt(Offset.getY-impl(Offset)) : MathKt.roundToInt(Offset.getX-impl(Offset));
    ...
    protected abstract long mo2091calculatePositionInParentR5De75A(@NotNull NodeCoordinator nodeCoordinator, long j);
