...
public final class HitTestResult<T> implements List<T>, KMappedMarker {
    ...
    private final long m2114findBestHitDistanceptXAw2c() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long m2106constructorimpl = DistanceAndInLayer.m2106constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m2105compareToS_HNhKs(m2106constructorimpl, access$DistanceAndInLayer) < 0) {
                    access$DistanceAndInLayer = m2106constructorimpl;
                }
                if (DistanceAndInLayer.m2109getDistanceimpl(access$DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m2111isInLayerimpl(access$DistanceAndInLayer)) {
    ...
    public final boolean hasHit() {
        long m2114findBestHitDistanceptXAw2c = m2114findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m2109getDistanceimpl(m2114findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m2111isInLayerimpl(m2114findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        return DistanceAndInLayer.m2105compareToS_HNhKs(m2114findBestHitDistanceptXAw2c(), HitTestResultKt.access$DistanceAndInLayer(f, z)) > 0;
    }
    ...
    public final void speculativeHit(T t, float f, boolean z, @NotNull Function0<Unit> function0) {
        ...
        hitInMinimumTouchTarget(t, f, z, function0);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(this) && DistanceAndInLayer.m2105compareToS_HNhKs(m2114findBestHitDistanceptXAw2c, m2114findBestHitDistanceptXAw2c()) > 0) {
