...
public final class LookaheadLayoutKt {
    ...
    public static final void LookaheadLayout(@NotNull final Function3<? super LookaheadLayoutScope, ? super Composer, ? super Integer, Unit> function3, @Nullable Modifier modifier, @NotNull final MeasurePolicy measurePolicy, @Nullable Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            Updater.set-impl(composer2, lookaheadLayoutScopeImpl, new Function2<LayoutNode, LookaheadLayoutScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadLayoutKt$LookaheadLayout$1$1
            ...
            Updater.init-impl(composer2, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadLayoutKt$LookaheadLayout$1$2
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LookaheadLayoutKt$LookaheadLayout$3
            ...
            public final void invoke(@Nullable Composer composer3, int i5) {
                LookaheadLayoutKt.LookaheadLayout(function3, modifier2, measurePolicy, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
}
