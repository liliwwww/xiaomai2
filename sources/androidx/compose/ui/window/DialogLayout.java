...
import androidx.compose.ui.window.ComposableSingletons;
import kotlin.Unit;
...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(@NotNull Context context, @NotNull Window window) {
        ...
        this.window = window;
        this.content$delegate = SnapshotStateKt.mutableStateOf$default(ComposableSingletons.AndroidDialog_androidKt.INSTANCE.getLambda-1$ui_release(), (SnapshotMutationPolicy) null, 2, (Object) null);
    }
