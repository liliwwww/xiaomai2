...
final class DialogWrapper extends ComponentDialog implements ViewRootForInspector {
    ...
    public DialogWrapper(@NotNull Function0<Unit> function0, @NotNull DialogProperties dialogProperties, @NotNull View view, @NotNull LayoutDirection layoutDirection, @NotNull Density density, @NotNull UUID uuid) {
        super(new ContextThemeWrapper(view.getContext(), (Build.VERSION.SDK_INT >= 31 || dialogProperties.getDecorFitsSystemWindows()) ? R.style.DialogWindowTheme : R.style.FloatingDialogWindowTheme), 0, 2, (DefaultConstructorMarker) null);
        ...
        float m2142constructorimpl = Dp.m2142constructorimpl(8);
        this.maxSupportedElevation = m2142constructorimpl;
        ...
        dialogLayout.setElevation(density.mo321toPx0680j_4(m2142constructorimpl));
        dialogLayout.setOutlineProvider(new 1.2());
    ...
    public boolean onTouchEvent(@NotNull MotionEvent motionEvent) {
        ...
        boolean onTouchEvent = super/*android.app.Dialog*/.onTouchEvent(motionEvent);
