...
public final class EmojiSupportMatch {
    ...
    private static final int Default = m1839constructorimpl(0);
    private static final int None = m1839constructorimpl(1);
    ...
    public static final class Companion {
        ...
        public final int m1845getDefault_3YsG6Y() {
            return EmojiSupportMatch.Default;
        }

        /* renamed from: getNone-_3YsG6Y, reason: not valid java name */
        public final int m1846getNone_3YsG6Y() {
    ...
    public static final /* synthetic */ EmojiSupportMatch m1838boximpl(int i) {
    ...
    public static boolean m1840equalsimpl(int i, Object obj) {
        return (obj instanceof EmojiSupportMatch) && i == ((EmojiSupportMatch) obj).m1844unboximpl();
    }
