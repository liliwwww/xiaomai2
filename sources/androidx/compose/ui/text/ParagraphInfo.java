...
public final class ParagraphInfo {
    ...
    public final Rect toGlobal(@NotNull Rect rect) {
        ...
        return rect.translate-k-4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m2261toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m2330getStartimpl(j)), toGlobalIndex(TextRange.m2325getEndimpl(j)));
    }
    ...
    public final long m2262toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.getX-impl(j), Offset.getY-impl(j) - this.top);
    }
    ...
    public final Path toGlobal(@NotNull Path path) {
        ...
        path.m1176translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }
