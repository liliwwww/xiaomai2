...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final boolean getAutoCorrect() {
        ISurgeon iSurgeon = $surgeonFlag;
        return InstrumentAPI.support(iSurgeon, "2") ? ((Boolean) iSurgeon.surgeon$dispatch("2", new Object[]{this})).booleanValue() : this.autoCorrect;
    }

    @Override // android.view.inputmethod.InputConnection
    public int getCursorCapsMode(int i) {
        ISurgeon iSurgeon = $surgeonFlag;
        return InstrumentAPI.support(iSurgeon, "33") ? ((Integer) iSurgeon.surgeon$dispatch("33", new Object[]{this, Integer.valueOf(i)})).intValue() : TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m2328getMinimpl(this.mTextFieldValue.getSelection-d9O1mEE()), i);
    }
    ...
    public final TextFieldValue getMTextFieldValue$ui_release() {
        ISurgeon iSurgeon = $surgeonFlag;
        return InstrumentAPI.support(iSurgeon, "3") ? (TextFieldValue) iSurgeon.surgeon$dispatch("3", new Object[]{this}) : this.mTextFieldValue;
    }
    ...
    public CharSequence getSelectedText(int i) {
        ...
        if (TextRange.m2324getCollapsedimpl(this.mTextFieldValue.getSelection-d9O1mEE())) {
            return null;
        }
    ...
    */
    public boolean performContextMenuAction(int r5) {
        /*
            r4 = this;
            com.alibaba.surgeon.bridge.ISurgeon r0 = androidx.compose.ui.text.input.RecordingInputConnection.$surgeonFlag
    ...
    public boolean performEditorAction(int i) {
        ...
        if (i != 0) {
            switch (i) {
                case 2:
                    i2 = ImeAction.Companion.getGo-eUduSuo();
                    break;
                case 3:
                    i2 = ImeAction.Companion.getSearch-eUduSuo();
                    break;
                case 4:
                    i2 = ImeAction.Companion.getSend-eUduSuo();
                    break;
                case 5:
                    i2 = ImeAction.Companion.getNext-eUduSuo();
                    break;
                case 6:
                    i2 = ImeAction.Companion.getDone-eUduSuo();
                    break;
                case 7:
                    i2 = ImeAction.Companion.getPrevious-eUduSuo();
                    break;
                default:
                    Log.w("RecordingIC", "IME sends unsupported Editor Action: " + i);
                    i2 = ImeAction.Companion.getDefault-eUduSuo();
                    break;
            }
        } else {
            i2 = ImeAction.Companion.getDefault-eUduSuo();
        }
        this.eventCallback.m2425onImeActionKlQnJC8(i2);
        return true;
    }
    ...
    public final void updateInputState(@NotNull TextFieldValue textFieldValue, @NotNull InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int m2328getMinimpl = textRange != null ? TextRange.m2328getMinimpl(textRange.m2334unboximpl()) : -1;
            TextRange textRange2 = textFieldValue.getComposition-MzsxiRA();
            inputMethodManager.updateSelection(TextRange.m2328getMinimpl(textFieldValue.getSelection-d9O1mEE()), TextRange.m2327getMaximpl(textFieldValue.getSelection-d9O1mEE()), m2328getMinimpl, textRange2 != null ? TextRange.m2327getMaximpl(textRange2.m2334unboximpl()) : -1);
        }
    }
}
