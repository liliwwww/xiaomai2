...
public final class TextLayoutResult {
    ...
    public static /* synthetic */ TextLayoutResult m1886copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m1887copyO0kMr_c(textLayoutInput, j);
    }
    ...
    public final TextLayoutResult m1887copyO0kMr_c(@NotNull TextLayoutInput textLayoutInput, long j) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) || !Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) || !IntSize.equals-impl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public final int m1888getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m1849getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m1889getSizeYbymL2g() {
        return this.size;
    }

    /* renamed from: getWordBoundary--jx7JFs, reason: not valid java name */
    public final long m1890getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m1850getWordBoundaryjx7JFs(i);
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.hashCode-impl(this.size)) * 31) + Float.floatToIntBits(this.firstBaseline)) * 31) + Float.floatToIntBits(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }
    ...
    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.toString-impl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
