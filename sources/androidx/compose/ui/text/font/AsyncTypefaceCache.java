...
public final class AsyncTypefaceCache {
    ...
    @NotNull
    private final Object PermanentFailure = AsyncTypefaceResult.constructor-impl((Object) null);

    @NotNull
    private final LruCache<Key, AsyncTypefaceResult> resultCache = new LruCache<>(16);

    @NotNull
    private final SimpleArrayMap<Key, AsyncTypefaceResult> permanentCache = new SimpleArrayMap<>(0, 1, (DefaultConstructorMarker) null);
    ...
    public final AsyncTypefaceResult m1907get1ASDuI8(@NotNull Font font, @NotNull PlatformFontLoader platformFontLoader) {
        ...
        synchronized (this.cacheLock) {
            try {
                if (obj == null) {
                    ...
                    this.resultCache.put(key, AsyncTypefaceResult.box-impl(AsyncTypefaceResult.constructor-impl(obj)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    */
    public final java.lang.Object runCached(@org.jetbrains.annotations.NotNull androidx.compose.ui.text.font.Font r6, @org.jetbrains.annotations.NotNull androidx.compose.ui.text.font.PlatformFontLoader r7, boolean r8, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r9, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<java.lang.Object> r10) {
        ...
        L5c:
            if (r7 == 0) goto L64
            java.lang.Object r7 = r7.unbox-impl()     // Catch: java.lang.Throwable -> Lb0
            monitor-exit(r6)
            return r7
        L64:
        ...
        L7a:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r7 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.box-impl(r7)     // Catch: java.lang.Throwable -> L8b
        ...
        L8d:
            ...
            java.lang.Object r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.constructor-impl(r10)     // Catch: java.lang.Throwable -> L8b
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.box-impl(r8)     // Catch: java.lang.Throwable -> L8b
    ...
    public final Object runCachedBlocking(@NotNull Font font, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function0<? extends Object> function0) {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                if (asyncTypefaceResult != null) {
                    Object obj = asyncTypefaceResult.unbox-impl();
