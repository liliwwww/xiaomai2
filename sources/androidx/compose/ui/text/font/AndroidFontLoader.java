    ...
    */
    ...
    public Typeface loadBlocking(@NotNull Font font) {
        ...
        if (FontLoadingStrategy.equals-impl0(mo1897getLoadingStrategyPKNRLFQ, companion.getBlocking-PKNRLFQ())) {
            ...
            typeface = AndroidFontLoader_androidKt.access$load((ResourceFont) font, context2);
        } else {
            if (!FontLoadingStrategy.equals-impl0(mo1897getLoadingStrategyPKNRLFQ, companion.getOptionalLocal-PKNRLFQ())) {
                ...
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.toString-impl(font.mo1897getLoadingStrategyPKNRLFQ())));
            }
            try {
                Result.Companion companion2 = Result.Companion;
                Context context3 = this.context;
                Intrinsics.checkNotNullExpressionValue(context3, "context");
                obj = Result.constructor-impl(AndroidFontLoader_androidKt.access$load((ResourceFont) font, context3));
            } catch (Throwable th) {
