...
public final class FontMatcher {
    ...
    public final List<Font> m1921matchFontRetOiIg(@NotNull FontFamily fontFamily, @NotNull FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (fontFamily instanceof FontListFontFamily) {
            return m1922matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, i);
        }
    ...
    @NotNull
    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m1922matchFontRetOiIg(@NotNull FontListFontFamily fontListFontFamily, @NotNull FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontListFontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m1923matchFontRetOiIg(fontListFontFamily.getFonts(), fontWeight, i);
    }

    @NotNull
    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m1923matchFontRetOiIg(@NotNull List<? extends Font> list, @NotNull FontWeight fontWeight, int i) {
        ...
        while (true) {
            ...
            Font font2 = font;
            if (Intrinsics.areEqual(font2.getWeight(), fontWeight) && FontStyle.m1927equalsimpl0(font2.mo1915getStyle_LCdwA(), i)) {
                arrayList.add(font);
            }
            i3++;
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (FontStyle.m1927equalsimpl0(font3.mo1915getStyle_LCdwA(), i)) {
