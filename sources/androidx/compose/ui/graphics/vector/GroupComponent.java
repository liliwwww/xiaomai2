...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m1153constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m1162resetimpl(fArr);
        }
        Matrix.m1173translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m1165rotateZimpl(fArr, this.rotation);
        Matrix.m1166scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m1173translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(@NotNull DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo1333transform58bKbWc(Matrix.m1151boximpl(fArr).m1174unboximpl());
        }
        Path path = this.clipPath;
