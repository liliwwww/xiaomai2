...
public final class PathNodeKt {
    ...
    private static final List<PathNode> pathNodesFromArgs(float[] fArr, int i, Function1<? super float[], ? extends PathNode> function1) {
        ...
        while (it.hasNext()) {
            ...
            PathNode.LineTo lineTo = (PathNode) function1.invoke(copyOfRange);
            if ((lineTo instanceof PathNode.MoveTo) && nextInt > 0) {
                lineTo = new PathNode.LineTo(copyOfRange[0], copyOfRange[1]);
            } else if ((lineTo instanceof PathNode.RelativeMoveTo) && nextInt > 0) {
                lineTo = new PathNode.RelativeLineTo(copyOfRange[0], copyOfRange[1]);
            }
    ...
    public static final List<PathNode> toPathNodes(char c, @NotNull float[] fArr) {
        ...
        if (c == 'm') {
            ...
            while (it.hasNext()) {
                ...
                PathNode.LineTo relativeMoveTo = new PathNode.RelativeMoveTo(copyOfRange[0], copyOfRange[1]);
            ...
            while (it2.hasNext()) {
                ...
                PathNode.LineTo moveTo = new PathNode.MoveTo(copyOfRange2[0], copyOfRange2[1]);
                if (nextInt2 > 0) {
            ...
            while (it3.hasNext()) {
                ...
                PathNode.LineTo relativeLineTo = new PathNode.RelativeLineTo(copyOfRange3[0], copyOfRange3[1]);
            ...
            while (it4.hasNext()) {
                ...
                PathNode.LineTo lineTo = new PathNode.LineTo(copyOfRange4[0], copyOfRange4[1]);
            ...
            while (it5.hasNext()) {
                ...
                PathNode.LineTo relativeHorizontalTo = new PathNode.RelativeHorizontalTo(copyOfRange5[0]);
            ...
            while (it6.hasNext()) {
                ...
                PathNode.LineTo horizontalTo = new PathNode.HorizontalTo(copyOfRange6[0]);
            ...
            while (it7.hasNext()) {
                ...
                PathNode.LineTo relativeVerticalTo = new PathNode.RelativeVerticalTo(copyOfRange7[0]);
            ...
            while (it8.hasNext()) {
                ...
                PathNode.LineTo verticalTo = new PathNode.VerticalTo(copyOfRange8[0]);
            ...
            if (c == 'c') {
                ...
                while (it9.hasNext()) {
                    ...
                    PathNode.LineTo relativeCurveTo = new PathNode.RelativeCurveTo(copyOfRange9[0], copyOfRange9[1], copyOfRange9[2], copyOfRange9[3], copyOfRange9[4], copyOfRange9[c4]);
                ...
                while (it10.hasNext()) {
                    ...
                    PathNode.LineTo curveTo = new PathNode.CurveTo(copyOfRange10[0], copyOfRange10[1], copyOfRange10[2], copyOfRange10[3], copyOfRange10[4], copyOfRange10[5]);
                ...
                while (it11.hasNext()) {
                    ...
                    PathNode.LineTo relativeReflectiveCurveTo = new PathNode.RelativeReflectiveCurveTo(copyOfRange11[0], copyOfRange11[1], copyOfRange11[2], copyOfRange11[3]);
                ...
                while (it12.hasNext()) {
                    ...
                    PathNode.LineTo reflectiveCurveTo = new PathNode.ReflectiveCurveTo(copyOfRange12[0], copyOfRange12[1], copyOfRange12[2], copyOfRange12[3]);
                ...
                while (it13.hasNext()) {
                    ...
                    PathNode.LineTo relativeQuadTo = new PathNode.RelativeQuadTo(copyOfRange13[0], copyOfRange13[1], copyOfRange13[2], copyOfRange13[3]);
                ...
                while (it14.hasNext()) {
                    ...
                    PathNode.LineTo quadTo = new PathNode.QuadTo(copyOfRange14[0], copyOfRange14[1], copyOfRange14[2], copyOfRange14[3]);
                ...
                while (it15.hasNext()) {
                    ...
                    PathNode.LineTo relativeReflectiveQuadTo = new PathNode.RelativeReflectiveQuadTo(copyOfRange15[0], copyOfRange15[1]);
                ...
                while (it16.hasNext()) {
                    ...
                    PathNode.LineTo reflectiveQuadTo = new PathNode.ReflectiveQuadTo(copyOfRange16[0], copyOfRange16[1]);
                ...
                while (it17.hasNext()) {
                    ...
                    PathNode.LineTo relativeArcTo = new PathNode.RelativeArcTo(f, f2, f3, z3, z2, copyOfRange17[c3], copyOfRange17[6]);
                ...
                while (it18.hasNext()) {
                    ...
                    PathNode.LineTo arcTo = new PathNode.ArcTo(f4, f5, f6, z4, z, copyOfRange18[c2], copyOfRange18[6]);
