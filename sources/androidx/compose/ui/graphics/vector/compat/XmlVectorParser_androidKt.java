...
public final class XmlVectorParser_androidKt {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources resources, @Nullable Resources.Theme theme, @NotNull AttributeSet attributeSet) {
        long m1084getUnspecified0d7_KjU;
        int i;
        ...
        if (obtainAttributes.hasValue(androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m1084getUnspecified0d7_KjU = Color.Companion.m1084getUnspecified0d7_KjU();
            } else {
                ...
                m1084getUnspecified0d7_KjU = namedColorStateList != null ? ColorKt.Color(namedColorStateList.getDefaultColor()) : Color.Companion.m1084getUnspecified0d7_KjU();
            }
        } else {
            m1084getUnspecified0d7_KjU = Color.Companion.m1084getUnspecified0d7_KjU();
        }
        long j = m1084getUnspecified0d7_KjU;
        int i2 = androidVectorParser.getInt(obtainAttributes, androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT_MODE(), -1);
        if (i2 == -1) {
            i = BlendMode.Companion.getSrcIn-0nO6VwU();
        } else if (i2 == 3) {
            i = BlendMode.Companion.getSrcOver-0nO6VwU();
        } else if (i2 == 5) {
            i = BlendMode.Companion.getSrcIn-0nO6VwU();
        } else if (i2 != 9) {
            switch (i2) {
                case 14:
                    i = BlendMode.Companion.getModulate-0nO6VwU();
                    break;
                case 15:
                    i = BlendMode.Companion.getScreen-0nO6VwU();
                    break;
                case 16:
                    i = BlendMode.Companion.getPlus-0nO6VwU();
                    break;
                default:
                    i = BlendMode.Companion.getSrcIn-0nO6VwU();
                    break;
            ...
            i = BlendMode.Companion.getSrcAtop-0nO6VwU();
        }
        int i3 = i;
        ...
        return new ImageVector.Builder(null, f, f2, namedFloat, namedFloat2, j, i3, namedBoolean, 1, null);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m1344getStrokeLineCapCSYIeUk(int i, int i2) {
        return i != 0 ? i != 1 ? i != 2 ? i2 : StrokeCap.Companion.m1210getSquareKaPHkGw() : StrokeCap.Companion.m1209getRoundKaPHkGw() : StrokeCap.Companion.m1208getButtKaPHkGw();
    }

    /* renamed from: getStrokeLineCap-CSYIeUk$default, reason: not valid java name */
    static /* synthetic */ int m1345getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m1208getButtKaPHkGw();
        }
        return m1344getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m1346getStrokeLineJoinkLtJ_vA(int i, int i2) {
        return i != 0 ? i != 1 ? i != 2 ? i2 : StrokeJoin.Companion.m1211getBevelLxFBmk8() : StrokeJoin.Companion.m1213getRoundLxFBmk8() : StrokeJoin.Companion.m1212getMiterLxFBmk8();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m1347getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m1212getMiterLxFBmk8();
        }
        return m1346getStrokeLineJoinkLtJ_vA(i, i2);
    }
    ...
    private static final Brush obtainBrushFromComplexColor(ComplexColorCompat complexColorCompat) {
        ...
        return shader != null ? BrushKt.ShaderBrush(shader) : new SolidColor(ColorKt.Color(complexColorCompat.getColor()), (DefaultConstructorMarker) null);
    }
    ...
    public static final void parseClipPath(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources resources, @Nullable Resources.Theme theme, @NotNull AttributeSet attributeSet, @NotNull ImageVector.Builder builder) {
        ...
        List addPathNodes = VectorKt.addPathNodes(androidVectorParser.getString(obtainAttributes, androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_CLIP_PATH_PATH_DATA()));
        obtainAttributes.recycle();
    ...
    public static final void parsePath(@NotNull AndroidVectorParser androidVectorParser, @NotNull Resources resources, @Nullable Resources.Theme theme, @NotNull AttributeSet attributeSet, @NotNull ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        String str = string;
        List<? extends PathNode> addPathNodes = VectorKt.addPathNodes(androidVectorParser.getString(obtainAttributes, androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_PATH_DATA()));
        ...
        int m1344getStrokeLineCapCSYIeUk = m1344getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m1208getButtKaPHkGw());
        int m1346getStrokeLineJoinkLtJ_vA = m1346getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m1211getBevelLxFBmk8());
        ...
        builder.m1327addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m1188getNonZeroRgk1Os() : companion.m1187getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m1344getStrokeLineCapCSYIeUk, m1346getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
