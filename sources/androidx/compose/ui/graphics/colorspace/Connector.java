...
public class Connector {
    ...
    public static final class Companion {
        ...
        public final float[] m1284computeTransformYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
            if (!RenderIntent.equals-impl0(i, RenderIntent.Companion.m1287getAbsoluteuksYyKA())) {
                return null;
            }
            long j = colorSpace.getModel-xdoWZVw();
            ColorModel.Companion companion = ColorModel.Companion;
            boolean z = ColorModel.equals-impl0(j, companion.getRgb-xdoWZVw());
            boolean z2 = ColorModel.equals-impl0(colorSpace2.getModel-xdoWZVw(), companion.getRgb-xdoWZVw());
            if (z && z2) {
                return null;
            }
            if (!z && !z2) {
        ...
        public final Connector identity$ui_graphics_release(@NotNull ColorSpace colorSpace) {
            ...
            return new identity.1(colorSpace, RenderIntent.Companion.m1289getRelativeuksYyKA());
        }
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m1285computeTransformYBCOT_4(rgb, rgb2, i);
        }
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        private final float[] m1285computeTransformYBCOT_4(Rgb rgb, Rgb rgb2, int i) {
        ...
        public long mo1282transformToColorwmQWz5c$ui_graphics_release(float f, float f2, float f3, float f4) {
    ...
    static {
        ...
        RenderIntent$Companion renderIntent$Companion = RenderIntent.Companion;
        SrgbToOklabPerceptual = new Connector(srgb, oklab, renderIntent$Companion.m1288getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(colorSpaces.getOklab(), colorSpaces.getSrgb(), renderIntent$Companion.m1288getPerceptualuksYyKA(), defaultConstructorMarker);
    }
    ...
    public final int m1281getRenderIntentuksYyKA() {
    ...
    public long mo1282transformToColorwmQWz5c$ui_graphics_release(float f, float f2, float f3, float f4) {
        ...
        return this.transformDestination.xyzaToColor-JlNiLsg$ui_graphics_release(f6, f5, z$ui_graphics_release, f4, this.destination);
    }
    ...
    */
    private Connector(androidx.compose.ui.graphics.colorspace.ColorSpace r13, androidx.compose.ui.graphics.colorspace.ColorSpace r14, int r15) {
        /*
            ...
            long r3 = r2.getRgb-xdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.equals-impl0(r0, r3)
            r1 = 2
            r3 = 0
            if (r0 == 0) goto L1e
        ...
        L1e:
            r7 = r13
        L1f:
            long r4 = r14.getModel-xdoWZVw()
            long r8 = r2.getRgb-xdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.equals-impl0(r4, r8)
            if (r0 == 0) goto L39
            androidx.compose.ui.graphics.colorspace.Illuminant r0 = androidx.compose.ui.graphics.colorspace.Illuminant.INSTANCE
            androidx.compose.ui.graphics.colorspace.WhitePoint r0 = r0.getD50()
        ...
        L3a:
            ...
            float[] r10 = androidx.compose.ui.graphics.colorspace.Connector.Companion.m1283access$computeTransformYBCOT_4(r0, r13, r14, r15)
            r11 = 0
            r4 = r12
            r5 = r13
            r6 = r14
