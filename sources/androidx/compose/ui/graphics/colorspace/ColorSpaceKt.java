...
public final class ColorSpaceKt {
    ...
    public static final Connector m1279connectYBCOT_4(@NotNull ColorSpace colorSpace, @NotNull ColorSpace colorSpace2, int i) {
        ...
        if (colorSpace == colorSpaces.getSrgb()) {
            ...
            if (colorSpace2 == colorSpaces.getOklab() && RenderIntent.equals-impl0(i, RenderIntent.Companion.m1288getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (colorSpace == colorSpaces.getOklab() && colorSpace2 == colorSpaces.getSrgb() && RenderIntent.equals-impl0(i, RenderIntent.Companion.m1288getPerceptualuksYyKA())) {
        ...
        return (ColorModel.equals-impl0(j, companion.getRgb-xdoWZVw()) && ColorModel.equals-impl0(colorSpace2.getModel-xdoWZVw(), companion.getRgb-xdoWZVw())) ? new Connector.RgbConnector((Rgb) colorSpace, (Rgb) colorSpace2, i, defaultConstructorMarker) : new Connector(colorSpace, colorSpace2, i, defaultConstructorMarker);
    }

    /* renamed from: connect-YBCOT_4$default, reason: not valid java name */
    public static /* synthetic */ Connector m1280connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m1288getPerceptualuksYyKA();
        }
        return m1279connectYBCOT_4(colorSpace, colorSpace2, i);
    }
