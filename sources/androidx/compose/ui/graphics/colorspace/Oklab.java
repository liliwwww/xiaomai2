...
public final class Oklab extends ColorSpace {
    ...
    public Oklab(@NotNull String str, int i) {
        super(str, ColorModel.Companion.getLab-xdoWZVw(), i, (DefaultConstructorMarker) null);
    ...
    public long m1286xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, @NotNull ColorSpace colorSpace) {
