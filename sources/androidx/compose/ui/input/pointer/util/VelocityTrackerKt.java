...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(@NotNull VelocityTracker velocityTracker, @NotNull PointerInputChange pointerInputChange) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m1503setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.m1465getPositionF1C5BW0());
            velocityTracker.resetTracking();
        }
        long m1466getPreviousPositionF1C5BW0 = pointerInputChange.m1466getPreviousPositionF1C5BW0();
        List<HistoricalChange> historical = pointerInputChange.getHistorical();
        int i = 0;
        int size = historical.size();
        while (i < size) {
            HistoricalChange historicalChange = historical.get(i);
            long m852minusMKHz9U = Offset.m852minusMKHz9U(historicalChange.getPosition-F1C5BW0(), m1466getPreviousPositionF1C5BW0);
            long j = historicalChange.getPosition-F1C5BW0();
            velocityTracker.m1503setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m853plusMKHz9U(velocityTracker.m1502getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), m852minusMKHz9U));
            velocityTracker.m1500addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.m1502getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
            i++;
            m1466getPreviousPositionF1C5BW0 = j;
        }
        velocityTracker.m1503setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m853plusMKHz9U(velocityTracker.m1502getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), Offset.m852minusMKHz9U(pointerInputChange.m1465getPositionF1C5BW0(), m1466getPreviousPositionF1C5BW0)));
        velocityTracker.m1500addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), velocityTracker.m1502getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
    }
