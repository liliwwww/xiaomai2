...
final class SuspendingPointerInputFilterKt$pointerInput$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(suspendingPointerInputFilter, this.$key1, new SuspendingPointerInputFilterKt$pointerInput$2$2$1(suspendingPointerInputFilter, this.$block, null), composer, 576);
        if (ComposerKt.isTraceInProgress()) {
