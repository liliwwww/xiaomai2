...
final class SuspendingPointerInputFilterKt$pointerInput$4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(suspendingPointerInputFilter, this.$key1, this.$key2, new 2.1(suspendingPointerInputFilter, this.$block, (Continuation) null), composer, 4672);
        if (ComposerKt.isTraceInProgress()) {
