...
public final class SlotTreeKt {
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo layoutInfo) {
        ...
        long mo1522getSizeYbymL2g = layoutInfo.getCoordinates().mo1522getSizeYbymL2g();
        int roundToInt = MathKt.roundToInt(Offset.m848getXimpl(positionInWindow));
        int roundToInt2 = MathKt.roundToInt(Offset.m849getYimpl(positionInWindow));
        return new IntRect(roundToInt, roundToInt2, IntSize.getWidth-impl(mo1522getSizeYbymL2g) + roundToInt, IntSize.getHeight-impl(mo1522getSizeYbymL2g) + roundToInt2);
    }
    ...
    */
    ...
    public static final List<ParameterInformation> findParameters(@NotNull CompositionGroup compositionGroup, @Nullable ContextCache contextCache) {
        ...
        if (contextCache == null) {
            ...
            Map contexts$ui_tooling_data_release = contextCache.getContexts$ui_tooling_data_release();
            Object obj = contexts$ui_tooling_data_release.get(sourceInfo);
            Object obj2 = obj;
            if (obj == null) {
                SourceInformationContext sourceInformationContextOf$default = sourceInformationContextOf$default(sourceInfo, null, 2, null);
                contexts$ui_tooling_data_release.put(sourceInfo, sourceInformationContextOf$default);
                obj2 = sourceInformationContextOf$default;
            }
            if (obj2 instanceof SourceInformationContext) {
                sourceInformationContext = (SourceInformationContext) obj2;
            }
        }
    ...
    private static final Group getGroup(CompositionGroup compositionGroup, SourceInformationContext sourceInformationContext) {
        ...
        while (it.hasNext()) {
            arrayList2.add(getGroup((CompositionGroup) it.next(), sourceInformationContextOf));
        }
    ...
    */
    ...
    private static final MatchResult m2109sourceInformationContextOf$next4(Ref.ObjectRef<MatchResult> objectRef) {
        MatchResult matchResult = (MatchResult) objectRef.element;
        if (matchResult != null) {
            objectRef.element = matchResult.next();
        }
    ...
    private static final SourceLocationInfo sourceInformationContextOf$parseLocation(Ref.ObjectRef<MatchResult> objectRef) {
        ...
        try {
            ...
            if (matchResult == null || !isNumber(matchResult)) {
                ...
                matchResult = m2109sourceInformationContextOf$next4(objectRef);
            }
            if (matchResult != null && isChar(matchResult, "@")) {
                MatchResult m2109sourceInformationContextOf$next4 = m2109sourceInformationContextOf$next4(objectRef);
                if (m2109sourceInformationContextOf$next4 != null && isNumber(m2109sourceInformationContextOf$next4)) {
                    num3 = Integer.valueOf(number(m2109sourceInformationContextOf$next4));
                    MatchResult m2109sourceInformationContextOf$next42 = m2109sourceInformationContextOf$next4(objectRef);
                    if (m2109sourceInformationContextOf$next42 != null && isChar(m2109sourceInformationContextOf$next42, "L")) {
                        MatchResult m2109sourceInformationContextOf$next43 = m2109sourceInformationContextOf$next4(objectRef);
                        if (m2109sourceInformationContextOf$next43 != null && isNumber(m2109sourceInformationContextOf$next43)) {
                            num2 = Integer.valueOf(number(m2109sourceInformationContextOf$next43));
                        }
                        return null;
                    }
                    num2 = null;
