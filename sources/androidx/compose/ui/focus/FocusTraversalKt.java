...
public final class FocusTraversalKt {
    ...
    */
    public static final void collectAccessibleChildren(@org.jetbrains.annotations.NotNull androidx.compose.ui.node.DelegatableNode r9, @org.jetbrains.annotations.NotNull androidx.compose.runtime.collection.MutableVector<androidx.compose.ui.focus.FocusTargetModifierNode> r10) {
        /*
            ...
            int r0 = androidx.compose.ui.node.NodeKind.m1660constructorimpl(r0)
        ...
        L72:
            ...
            int r6 = r6.getEnter-dhqQ-8s()
            androidx.compose.ui.focus.FocusDirection r6 = androidx.compose.ui.focus.FocusDirection.box-impl(r6)
    ...
    */
    public static final androidx.compose.ui.focus.FocusTargetModifierNode findActiveFocusNode(@org.jetbrains.annotations.NotNull androidx.compose.ui.focus.FocusTargetModifierNode r6) {
        ...
        L25:
            ...
            androidx.compose.ui.node.DelegatableNodeKt.access$addLayoutNodeChildren(r4, r6)
            goto L54
        L51:
            r4.add(r2)
        L54:
        ...
        while (requireLayoutNode != null) {
            if ((requireLayoutNode.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m1660constructorimpl) != 0) {
                while (parent$ui_release != null) {
                    if ((parent$ui_release.getKindSet$ui_release() & m1660constructorimpl) != 0 && (parent$ui_release instanceof FocusTargetModifierNode)) {
    ...
    public static final boolean m831focusSearchsMXa3k8(@NotNull FocusTargetModifierNode focusTargetModifierNode, int i, @NotNull LayoutDirection layoutDirection, @NotNull Function1<? super FocusTargetModifierNode, Boolean> function1) {
        int i2;
        ...
        if (FocusDirection.equals-impl0(i, companion.getNext-dhqQ-8s()) ? true : FocusDirection.equals-impl0(i, companion.getPrevious-dhqQ-8s())) {
            return OneDimensionalFocusSearchKt.m834oneDimensionalFocusSearchOMvw8(focusTargetModifierNode, i, function1);
        }
        if (FocusDirection.equals-impl0(i, companion.getLeft-dhqQ-8s()) ? true : FocusDirection.equals-impl0(i, companion.getRight-dhqQ-8s()) ? true : FocusDirection.equals-impl0(i, companion.getUp-dhqQ-8s()) ? true : FocusDirection.equals-impl0(i, companion.getDown-dhqQ-8s())) {
            return TwoDimensionalFocusSearchKt.twoDimensionalFocusSearch--OM-vw8(focusTargetModifierNode, i, function1);
        }
        ...
        if (i3 == 1) {
            i2 = companion.getLeft-dhqQ-8s();
        } else {
            if (i3 != 2) {
                throw new NoWhenBranchMatchedException();
            }
            i2 = companion.getRight-dhqQ-8s();
        }
        FocusTargetModifierNode findActiveFocusNode2 = findActiveFocusNode(focusTargetModifierNode);
        if (findActiveFocusNode2 != null) {
            return TwoDimensionalFocusSearchKt.twoDimensionalFocusSearch--OM-vw8(findActiveFocusNode2, i2, function1);
        }
        return false;
    }
