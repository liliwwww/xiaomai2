...
public final class OneDimensionalFocusSearchKt {
    ...
    private static final boolean backwardFocusSearch(FocusTargetModifierNode focusTargetModifierNode, Function1<? super FocusTargetModifierNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (i2 != 1) {
                if (i2 == 2 || i2 == 3) {
                    return m833generateAndSearchChildren4C6V_qg(focusTargetModifierNode, activeChild, FocusDirection.Companion.getPrevious-dhqQ-8s(), function1);
                }
                if (i2 != 4) {
            ...
            if (!backwardFocusSearch(activeChild, function1) && !m833generateAndSearchChildren4C6V_qg(focusTargetModifierNode, activeChild, FocusDirection.Companion.getPrevious-dhqQ-8s(), function1) && (!focusTargetModifierNode.fetchFocusProperties$ui_release().getCanFocus() || !((Boolean) function1.invoke(activeChild)).booleanValue())) {
                return false;
            }
        } else {
            if (i == 2 || i == 3) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetModifierNode focusTargetModifierNode, Function1<? super FocusTargetModifierNode, Boolean> function1) {
        ...
        if (i == 1) {
            FocusTargetModifierNode activeChild = FocusTraversalKt.getActiveChild(focusTargetModifierNode);
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m833generateAndSearchChildren4C6V_qg(focusTargetModifierNode, activeChild, FocusDirection.Companion.getNext-dhqQ-8s(), function1);
            }
            throw new IllegalStateException(NoActiveChild.toString());
        }
        if (i == 2 || i == 3) {
    ...
    private static final boolean m833generateAndSearchChildren4C6V_qg(final FocusTargetModifierNode focusTargetModifierNode, final FocusTargetModifierNode focusTargetModifierNode2, final int i, final Function1<? super FocusTargetModifierNode, Boolean> function1) {
        if (m835searchChildren4C6V_qg(focusTargetModifierNode, focusTargetModifierNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m825searchBeyondBoundsOMvw8(focusTargetModifierNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(@NotNull BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean m835searchChildren4C6V_qg;
                Intrinsics.checkNotNullParameter(beyondBoundsScope, "$this$searchBeyondBounds");
                m835searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m835searchChildren4C6V_qg(FocusTargetModifierNode.this, focusTargetModifierNode2, i, function1);
                Boolean valueOf = Boolean.valueOf(m835searchChildren4C6V_qg);
    ...
    public static final boolean m834oneDimensionalFocusSearchOMvw8(@NotNull FocusTargetModifierNode focusTargetModifierNode, int i, @NotNull Function1<? super FocusTargetModifierNode, Boolean> function1) {
    ...
    private static final boolean pickChildForBackwardSearch(FocusTargetModifierNode focusTargetModifierNode, Function1<? super FocusTargetModifierNode, Boolean> function1) {
        ...
        while (mutableVector2.isNotEmpty()) {
            Modifier$Node modifier$Node = (Modifier$Node) mutableVector2.removeAt(mutableVector2.getSize() - 1);
            if ((modifier$Node.getAggregateChildKindSet$ui_release() & m1660constructorimpl) == 0) {
                DelegatableNodeKt.addLayoutNodeChildren(mutableVector2, modifier$Node);
            } else {
                while (true) {
                    ...
                    if ((modifier$Node.getKindSet$ui_release() & m1660constructorimpl) == 0) {
                        ...
                        mutableVector.add((FocusTargetModifierNode) modifier$Node);
                    }
                }
            }
        }
    ...
    public static final boolean m835searchChildren4C6V_qg(FocusTargetModifierNode focusTargetModifierNode, FocusTargetModifierNode focusTargetModifierNode2, int i, Function1<? super FocusTargetModifierNode, Boolean> function1) {
        ...
        if (FocusDirection.equals-impl0(i, FocusDirection.Companion.getNext-dhqQ-8s()) || !focusTargetModifierNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetModifierNode)) {
            return false;
        }
