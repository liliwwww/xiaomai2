...
public final class MutableRect {
    ...
    public final boolean m1017containsk4lQ0M(long j) {
        return Offset.getX-impl(j) >= this.left && Offset.getX-impl(j) < this.right && Offset.getY-impl(j) >= this.top && Offset.getY-impl(j) < this.bottom;
    }
    ...
    public final long m1018getSizeNHjbRc() {
