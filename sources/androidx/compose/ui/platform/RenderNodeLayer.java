...
public final class RenderNodeLayer implements GraphicLayerInfo, OwnedLayer {
    ...
    @NotNull
    private static final Function2<DeviceRenderNode, Matrix, Unit> getMatrix = Companion.getMatrix.1.INSTANCE;
    ...
    public RenderNodeLayer(@NotNull AndroidComposeView androidComposeView, @NotNull Function1<? super Canvas, Unit> function1, @NotNull Function0<Unit> function0) {
        ...
        this.transformOrigin = TransformOrigin.Companion.m1223getCenterSzJe1aQ();
        RenderNodeApi29 renderNodeApi29 = Build.VERSION.SDK_INT >= 29 ? new RenderNodeApi29(androidComposeView) : new RenderNodeApi23(androidComposeView);
    ...
    public void drawLayer(@NotNull Canvas canvas) {
        ...
        canvas.mo1049concat58bKbWc(this.matrixCache.calculateMatrix-GrdbGEg(this.renderNode));
    ...
    public void m2225inverseTransform58bKbWc(@NotNull float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        float[] fArr2 = this.matrixCache.calculateInverseMatrix-bWbORWo(this.renderNode);
        if (fArr2 != null) {
    ...
    public boolean m2226isInLayerk4lQ0M(long j) {
        float f = Offset.getX-impl(j);
        float f2 = Offset.getY-impl(j);
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= f && f < ((float) this.renderNode.getWidth()) && 0.0f <= f2 && f2 < ((float) this.renderNode.getHeight());
        }
    ...
    public void mapBounds(@NotNull MutableRect mutableRect, boolean z) {
        ...
        if (!z) {
            androidx.compose.ui.graphics.Matrix.map-impl(this.matrixCache.calculateMatrix-GrdbGEg(this.renderNode), mutableRect);
            return;
        }
        float[] fArr = this.matrixCache.calculateInverseMatrix-bWbORWo(this.renderNode);
        if (fArr == null) {
    ...
    public long m2227mapOffset8S9VItk(long j, boolean z) {
        if (!z) {
            return androidx.compose.ui.graphics.Matrix.map-MK-Hz9U(this.matrixCache.calculateMatrix-GrdbGEg(this.renderNode), j);
        }
        float[] fArr = this.matrixCache.calculateInverseMatrix-bWbORWo(this.renderNode);
    ...
    public void m2228movegyyYBs(long j) {
        int left = this.renderNode.getLeft();
        int top = this.renderNode.getTop();
        int m2643getXimpl = IntOffset.m2643getXimpl(j);
        int m2644getYimpl = IntOffset.m2644getYimpl(j);
        if (left == m2643getXimpl && top == m2644getYimpl) {
            return;
        }
        this.renderNode.offsetLeftAndRight(m2643getXimpl - left);
        this.renderNode.offsetTopAndBottom(m2644getYimpl - top);
        triggerRepaint();
        this.matrixCache.invalidate();
    }

    /* renamed from: resize-ozmzZPI, reason: not valid java name */
    public void m2229resizeozmzZPI(long j) {
        ...
        this.renderNode.setPivotX(TransformOrigin.getPivotFractionX-impl(this.transformOrigin) * f);
        float f2 = m2684getHeightimpl;
        this.renderNode.setPivotY(TransformOrigin.getPivotFractionY-impl(this.transformOrigin) * f2);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + m2685getWidthimpl, this.renderNode.getTop() + m2684getHeightimpl)) {
    ...
    public void m2230transform58bKbWc(@NotNull float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        androidx.compose.ui.graphics.Matrix.timesAssign-58bKbWc(fArr, this.matrixCache.calculateMatrix-GrdbGEg(this.renderNode));
    }
    ...
    public void m2231updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, @NotNull Shape shape, boolean z, @Nullable RenderEffect renderEffect, long j2, long j3, int i, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.toArgb-8_81llA(j2));
        this.renderNode.setSpotShadowColor(ColorKt.toArgb-8_81llA(j3));
        ...
        this.renderNode.setPivotX(TransformOrigin.getPivotFractionX-impl(j) * this.renderNode.getWidth());
        this.renderNode.setPivotY(TransformOrigin.getPivotFractionY-impl(j) * this.renderNode.getHeight());
        ...
        this.renderNode.m2216setCompositingStrategyaDBOjCE(i);
