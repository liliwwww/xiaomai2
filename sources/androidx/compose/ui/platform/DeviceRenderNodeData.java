...
public final class DeviceRenderNodeData {
    ...
    public final int m1749component25NrFUSI() {
    ...
    public final DeviceRenderNodeData m1750copyfuCbV5c(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, @Nullable RenderEffect renderEffect, int i9) {
    ...
    public final int m1751getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public int hashCode() {
        ...
        return ((floatToIntBits + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.hashCode-impl(this.compositingStrategy);
    }
    ...
    public final void m1752setCompositingStrategyaDBOjCE(int i) {
