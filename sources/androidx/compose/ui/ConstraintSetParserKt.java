...
public final class ConstraintSetParserKt {
                ...
                while (it2.hasNext()) {
                    ...
                    if (stringOrNull != null) {
                        ...
                        if (hashCode != -1727069561) {
                            ...
                            object.remove(MotionKey.VISIBILITY);
                            object.remove(MotionKey.ALPHA);
                            object.remove("pivotX");
                            object.remove("pivotY");
                            object.remove(MotionKey.ROTATION_X);
                            object.remove("rotationY");
                            object.remove(MotionKey.ROTATION);
                            object.remove(MotionKey.SCALE_X);
                            object.remove(MotionKey.SCALE_Y);
                            object.remove(MotionKey.TRANSLATION_X);
                            object.remove(MotionKey.TRANSLATION_Y);
                        } else {
                            object.remove(stringOrNull);
                        }
                    }
    ...
    */
    public static final void parseChain(int r7, @org.jetbrains.annotations.NotNull androidx.compose.ui.State r8, @org.jetbrains.annotations.NotNull androidx.compose.ui.LayoutVariables r9, @org.jetbrains.annotations.NotNull androidx.constraintlayout.core.parser.CLArray r10) {
        /*
        ...
        Lf6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.ConstraintSetParserKt.parseChain(int, androidx.constraintlayout.compose.State, androidx.constraintlayout.compose.LayoutVariables, androidx.constraintlayout.core.parser.CLArray):void");
    }
    ...
    private static final void parseConstraint(State state, LayoutVariables layoutVariables, CLObject cLObject, ConstraintReference constraintReference, String str) {
        ...
        if (arrayOrNull.size() > 2) {
            ...
            f = state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(layoutVariables.get(orNull))));
        } else {
            f = 0.0f;
        }
        if (arrayOrNull.size() > 3) {
            ...
            f2 = state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(layoutVariables.get(orNull2))));
        } else {
            f2 = 0.0f;
        }
    ...
    */
    public static final void parseConstraintSets(@org.jetbrains.annotations.NotNull androidx.constraintlayout.compose.MotionScene r13, @org.jetbrains.annotations.NotNull java.lang.Object r14) {
        ...
        Lbf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.ConstraintSetParserKt.parseConstraintSets(androidx.constraintlayout.compose.MotionScene, java.lang.Object):void");
    }
                ...
                while (it2.hasNext()) {
                    ...
                    if (stringOrNull != null) {
                        ...
                        if (size >= 0) {
                            ...
                            while (true) {
                                int i3 = i2 + 1;
                                CLKey cLKey = cLObject3.get(i2);
                                cLObject = parse;
                                Objects.requireNonNull(cLKey, "null cannot be cast to non-null type androidx.constraintlayout.core.parser.CLKey");
                                CLKey cLKey2 = cLKey;
                                String content = cLKey2.content();
                                CLElement value = cLKey2.getValue();
    ...
    private static final Dimension parseDimension(CLObject cLObject, String str, State state) {
        ...
        if (cLElement instanceof CLNumber) {
            Dimension Fixed2 = Dimension.Fixed(state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(cLObject.getFloat(str)))));
        ...
        if (orNull != null) {
            if (orNull instanceof CLNumber) {
                Fixed.min(state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(orNull.getFloat()))));
        ...
        if (orNull2 instanceof CLNumber) {
            Fixed.max(state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(orNull2.getFloat()))));
            return Fixed;
        }
    ...
    private static final void parseGuidelineParams(int i, State state, String str, CLObject cLObject) {
        ...
        GuidelineReference facade = constraints.getFacade();
                ...
                if (hashCode != -678927291) {
                    if (hashCode != 100571) {
                        if (hashCode == 109757538 && str2.equals("start")) {
                            guidelineReference.start(Integer.valueOf(state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(cLObject.getFloat(str2))))));
                        }
                    } else if (str2.equals("end")) {
                        guidelineReference.end(Integer.valueOf(state.convertDimension(Dp.m2140boximpl(Dp.m2142constructorimpl(cLObject.getFloat(str2))))));
                    }
    ...
    public static final void parseJSON(@NotNull String str, @NotNull Transition transition, int i) {
    ...
    public static final void parseKeyAttribute(@NotNull CLObject cLObject, @NotNull Transition transition) {
        CLArray arrayOrNull;
        ...
        ArrayList arrayListOf = CollectionsKt.arrayListOf(new String[]{MotionKey.SCALE_X, MotionKey.SCALE_Y, MotionKey.TRANSLATION_X, MotionKey.TRANSLATION_Y, "translationZ", MotionKey.ROTATION_X, "rotationY", MotionKey.ROTATION, MotionKey.ALPHA});
        ArrayList arrayListOf2 = CollectionsKt.arrayListOf(new Integer[]{311, 312, 304, 305, 306, Integer.valueOf(e.HTTP_PERM_REDIRECT), 309, 310, 303});
    ...
    */
    public static final void parseKeyCycle(@org.jetbrains.annotations.NotNull androidx.constraintlayout.core.parser.CLObject r18, @org.jetbrains.annotations.NotNull androidx.constraintlayout.core.state.Transition r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.ConstraintSetParserKt.parseKeyCycle(androidx.constraintlayout.core.parser.CLObject, androidx.constraintlayout.core.state.Transition):void");
    }
    ...
    java.lang.NullPointerException: Cannot invoke "java.util.List.iterator()" because the return value of "jadx.core.dex.visitors.regions.SwitchOverStringVisitor$SwitchData.getNewCases()" is null
    	...
    	at jadx.core.dex.visitors.regions.DepthRegionTraversal.traverseIterativeStepInternal(DepthRegionTraversal.java:82)
     */
    public static final void parseKeyPosition(@NotNull CLObject cLObject, @NotNull Transition transition) {
        int i;
    ...
    java.lang.NullPointerException: Cannot invoke "java.util.List.iterator()" because the return value of "jadx.core.dex.visitors.regions.SwitchOverStringVisitor$SwitchData.getNewCases()" is null
    	...
    	at jadx.core.dex.visitors.regions.DepthRegionTraversal.traverseIterativeStepInternal(DepthRegionTraversal.java:82)
     */
    public static final void parseTransition(@NotNull CLObject cLObject, @NotNull Transition transition) {
        boolean z;
    ...
    public static final void parseWidget(@NotNull State state, @NotNull LayoutVariables layoutVariables, @NotNull String str, @NotNull CLObject cLObject) {
        ...
        if (constraints.getWidth() == null) {
            constraints.setWidth(Dimension.Wrap());
        }
        if (constraints.getHeight() == null) {
            constraints.setHeight(Dimension.Wrap());
        }
        ArrayList<String> names = cLObject.names();
        if (names == null) {
            return;
                ...
                switch (str2.hashCode()) {
                    ...
                    case -1364013995:
                        if (!str2.equals("center")) {
                            ...
                            ConstraintReference constraints3 = string2.equals("parent") ? state.constraints(State.PARENT) : state.constraints(string2);
                    ...
                    case -1249320806:
                        if (!str2.equals(MotionKey.ROTATION_X)) {
                            break;
                        } else {
                    ...
                    case -1249320804:
                        if (!str2.equals(MotionKey.ROTATION)) {
                            break;
                        } else {
                    ...
                    case -1225497657:
                        if (!str2.equals(MotionKey.TRANSLATION_X)) {
                            break;
                        } else {
                    ...
                    case -1225497656:
                        if (!str2.equals(MotionKey.TRANSLATION_Y)) {
                            break;
                        } else {
                    ...
                    case -908189618:
                        if (!str2.equals(MotionKey.SCALE_X)) {
                            break;
                        } else {
                    ...
                    case -908189617:
                        if (!str2.equals(MotionKey.SCALE_Y)) {
                            break;
                        } else {
                    ...
                    case 92909918:
                        if (!str2.equals(MotionKey.ALPHA)) {
                            break;
                        } else {
                    ...
                    case 1404070310:
                        if (!str2.equals("centerHorizontally")) {
                            ...
                            ConstraintReference constraints4 = string3.equals("parent") ? state.constraints(State.PARENT) : state.constraints(string3);
                            constraints.startToStart(constraints4);
                            constraints.endToEnd(constraints4);
                            break;
                        }
                    case 1941332754:
                        if (!str2.equals(MotionKey.VISIBILITY)) {
                            break;
                        } else {
