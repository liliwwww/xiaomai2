...
public final class MotionMeasurer extends Measurer {
    ...
    private final void m2305drawFrameg2O1Hgs(DrawScope drawScope, WidgetFrame widgetFrame, PathEffect pathEffect, long j) {
        if (widgetFrame.isDefaultTransform()) {
            DrawScope.DefaultImpls.drawRect-n-J9OG0$default(drawScope, j, OffsetKt.Offset(widgetFrame.left, widgetFrame.top), SizeKt.Size(widgetFrame.width(), widgetFrame.height()), 0.0f, new Stroke(3.0f, 0.0f, 0, 0, pathEffect, 14, (DefaultConstructorMarker) null), (ColorFilter) null, 0, 104, (Object) null);
            return;
        }
        ...
        DrawScope.DefaultImpls.drawLine-NGM6Ib0$default(drawScope, j, OffsetKt.Offset(fArr[0], fArr[1]), OffsetKt.Offset(fArr[2], fArr[3]), 3.0f, 0, pathEffect, 0.0f, (ColorFilter) null, 0, 464, (Object) null);
        DrawScope.DefaultImpls.drawLine-NGM6Ib0$default(drawScope, j, OffsetKt.Offset(fArr[2], fArr[3]), OffsetKt.Offset(fArr[4], fArr[5]), 3.0f, 0, pathEffect, 0.0f, (ColorFilter) null, 0, 464, (Object) null);
        DrawScope.DefaultImpls.drawLine-NGM6Ib0$default(drawScope, j, OffsetKt.Offset(fArr[4], fArr[5]), OffsetKt.Offset(fArr[6], fArr[7]), 3.0f, 0, pathEffect, 0.0f, (ColorFilter) null, 0, 464, (Object) null);
        DrawScope.DefaultImpls.drawLine-NGM6Ib0$default(drawScope, j, OffsetKt.Offset(fArr[6], fArr[7]), OffsetKt.Offset(fArr[0], fArr[1]), 3.0f, 0, pathEffect, 0.0f, (ColorFilter) null, 0, 464, (Object) null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawFrameDebug-PE3pjmc, reason: not valid java name */
    public final void m2306drawFrameDebugPE3pjmc(DrawScope drawScope, float f, float f2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, PathEffect pathEffect, long j) {
        m2305drawFrameg2O1Hgs(drawScope, widgetFrame, pathEffect, j);
        m2305drawFrameg2O1Hgs(drawScope, widgetFrame2, pathEffect, j);
        int numberKeyPositions = this.transition.getNumberKeyPositions(widgetFrame);
        new MotionRenderDebug(23.0f).draw(AndroidCanvas_androidKt.getNativeCanvas(drawScope.getDrawContext().getCanvas()), this.transition.getMotion(widgetFrame.widget.stringId), WVURLRuleConstants.LOGIN, 1, (int) f, (int) f2);
        ...
        while (true) {
            ...
            Path.lineTo(f5, f6 - 20.0f);
            Path.close();
            DrawScope.DefaultImpls.drawPath-LG529CI$default(drawScope, Path, j, 1.0f, new Stroke(3.0f, 0.0f, 0, 0, (PathEffect) null, 30, (DefaultConstructorMarker) null), (ColorFilter) null, 0, 48, (Object) null);
            if (i == i2) {
                return;
            } else {
                i = i3;
    ...
    private final void m2307measureConstraintSethBUhpc(int optimizationLevel, ConstraintSet constraintSet, List<? extends Measurable> measurables, long constraints) {
        String obj;
        getState().reset();
        ...
        if (size >= 0) {
            ...
            while (true) {
                int i2 = i + 1;
                ((ConstraintWidget) children.get(i)).setAnimated(true);
                if (i2 > size) {
                    break;
                } else {
                    i = i2;
        ...
        for (ConstraintWidget constraintWidget2 : children3) {
            ...
            if (layoutId2 == null) {
                layoutId2 = measurable2 == null ? null : C0010ConstraintLayoutTagKt.getConstraintLayoutId(measurable2);
            }
    ...
    */
    private final boolean m2308needsRemeasureBRTryo0(long r8) {
        /*
            r7 = this;
            ...
            goto La4
        L15:
            boolean r0 = androidx.compose.ui.unit.Constraints.m2119getHasFixedHeightimpl(r8)
            if (r0 == 0) goto L29
            androidx.constraintlayout.compose.State r0 = r7.getState()
            int r2 = androidx.compose.ui.unit.Constraints.m2121getMaxHeightimpl(r8)
            boolean r0 = r0.sameFixedHeight(r2)
            if (r0 == 0) goto L3d
        L29:
            boolean r0 = androidx.compose.ui.unit.Constraints.m2120getHasFixedWidthimpl(r8)
            if (r0 == 0) goto L3e
            androidx.constraintlayout.compose.State r0 = r7.getState()
            int r8 = androidx.compose.ui.unit.Constraints.m2122getMaxWidthimpl(r8)
        ...
        La4:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.MotionMeasurer.m2308needsRemeasureBRTryo0(long):boolean");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final void m2309recalculateInterpolation36Wf7g4(long r13, androidx.compose.ui.unit.LayoutDirection r15, androidx.constraintlayout.compose.ConstraintSet r16, androidx.constraintlayout.compose.ConstraintSet r17, androidx.compose.ui.Transition r18, java.util.List<? extends androidx.compose.ui.layout.Measurable> r19, int r20, float r21, boolean r22) {
        /*
            Method dump skipped, instructions count: 352
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.MotionMeasurer.m2309recalculateInterpolation36Wf7g4(long, androidx.compose.ui.unit.LayoutDirection, androidx.constraintlayout.compose.ConstraintSet, androidx.constraintlayout.compose.ConstraintSet, androidx.constraintlayout.compose.Transition, java.util.List, int, float, boolean):void");
    }
    ...
    @Override // androidx.compose.ui.Measurer
    public void computeLayoutResult() {
        ...
        while (it.hasNext()) {
            ...
            sb.append(' ' + ((Object) constraintWidget.stringId) + ": {");
    ...
    public final void drawDebug(@NotNull final BoxScope boxScope, @Nullable Composer composer, final int i) {
        ...
        CanvasKt.Canvas(boxScope.matchParentSize(Modifier.Companion), new Function1<DrawScope, Unit>() { // from class: androidx.constraintlayout.compose.MotionMeasurer$drawDebug$1
            ...
            public final void invoke(@NotNull DrawScope drawScope) {
                ...
                Iterator it = MotionMeasurer.this.getRoot().getChildren().iterator();
                while (it.hasNext()) {
                    ConstraintWidget constraintWidget = (ConstraintWidget) it.next();
                    WidgetFrame start = MotionMeasurer.this.getTransition().getStart(constraintWidget);
                    WidgetFrame end = MotionMeasurer.this.getTransition().getEnd(constraintWidget);
                    ...
                    motionMeasurer.m2306drawFrameDebugPE3pjmc(drawScope, m903getWidthimpl, m900getHeightimpl, start, end, dashPathEffect, companion.getWhite-0d7_KjU());
                    drawScope.getDrawContext().getTransform().translate(-2.0f, -2.0f);
                    MotionMeasurer.this.m2306drawFrameDebugPE3pjmc(drawScope, Size.m903getWidthimpl(drawScope.mo1321getSizeNHjbRc()), Size.m900getHeightimpl(drawScope.mo1321getSizeNHjbRc()), start, end, dashPathEffect, companion.getBlue-0d7_KjU());
                }
            }
        }, startRestartGroup, 0);
    ...
    public final long m2310getCustomColorWaAFU9c(@NotNull String id, @NotNull String name) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final long m2311performInterpolationMeasureOQbXsTc(long r13, @org.jetbrains.annotations.NotNull androidx.compose.ui.unit.LayoutDirection r15, @org.jetbrains.annotations.NotNull androidx.constraintlayout.compose.ConstraintSet r16, @org.jetbrains.annotations.NotNull androidx.constraintlayout.compose.ConstraintSet r17, @org.jetbrains.annotations.Nullable androidx.compose.ui.Transition r18, @org.jetbrains.annotations.NotNull java.util.List<? extends androidx.compose.ui.layout.Measurable> r19, int r20, float r21, @org.jetbrains.annotations.NotNull androidx.compose.ui.layout.MeasureScope r22) {
        /*
            r12 = this;
            r11 = r12
            r0 = r22
            ...
            boolean r10 = r12.m2308needsRemeasureBRTryo0(r13)
        ...
        L6e:
            ...
            r8 = r20
            r9 = r21
            r0.m2309recalculateInterpolation36Wf7g4(r1, r3, r4, r5, r6, r7, r8, r9, r10)
        L80:
