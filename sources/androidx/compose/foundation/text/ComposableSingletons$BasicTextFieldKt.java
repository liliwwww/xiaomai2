...
public final class ComposableSingletons$BasicTextFieldKt {
    ...
    @NotNull
    public static Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> f0lambda1 = ComposableLambdaKt.composableLambdaInstance(997835932, false, lambda-1.1.INSTANCE);
    ...
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m546getLambda1$foundation_release() {
        return f0lambda1;
    }

    @NotNull
    /* renamed from: getLambda-2$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m547getLambda2$foundation_release() {
        return f1lambda2;
    }

    @NotNull
    /* renamed from: getLambda-3$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m548getLambda3$foundation_release() {
        return f2lambda3;
    }

    @NotNull
    /* renamed from: getLambda-4$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m549getLambda4$foundation_release() {
        return f3lambda4;
    }
}
