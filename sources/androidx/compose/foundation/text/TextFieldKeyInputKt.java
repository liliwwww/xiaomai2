...
public final class TextFieldKeyInputKt {
    ...
    public static final Modifier textFieldKeyInput(@NotNull Modifier modifier, @NotNull final TextFieldState textFieldState, @NotNull final TextFieldSelectionManager textFieldSelectionManager, @NotNull final TextFieldValue textFieldValue, @NotNull final Function1<? super TextFieldValue, Unit> function1, final boolean z, final boolean z2, @NotNull final OffsetMapping offsetMapping, @NotNull final UndoManager undoManager) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldKeyInputKt$textFieldKeyInput$2
            ...
            /* synthetic */ class C05991 extends FunctionReferenceImpl implements Function1<KeyEvent, Boolean> {
                C05991(Object obj) {
                    super(1, obj, TextFieldKeyInput.class, "process", "process-ZmokQxo(Landroid/view/KeyEvent;)Z", 0);
                }

                public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                    return m1791invokeZmokQxo(((KeyEvent) obj).m3953unboximpl());
                }

                @NotNull
                /* renamed from: invoke-ZmokQxo, reason: not valid java name */
                public final Boolean m1791invokeZmokQxo(@NotNull android.view.KeyEvent keyEvent) {
                    Intrinsics.checkNotNullParameter(keyEvent, "p0");
                    return Boolean.valueOf(((TextFieldKeyInput) ((CallableReference) this).receiver).m1790processZmokQxo(keyEvent));
                }
            }
            ...
            public final Modifier invoke(@NotNull Modifier modifier2, @Nullable Composer composer, int i) {
                ...
                Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.Companion, new C05991(new TextFieldKeyInput(TextFieldState.this, textFieldSelectionManager, textFieldValue, z, z2, textPreparedSelectionState, offsetMapping, undoManager, (DeadKeyCombiner) rememberedValue2, null, function1, 512, null)));
                if (ComposerKt.isTraceInProgress()) {
