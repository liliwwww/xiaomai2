...
public final class SelectionAdjustment$Companion$Paragraph$1 implements SelectionAdjustment {
    ...
    public long mo463adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long j, int i, boolean z, @Nullable TextRange textRange) {
        ...
        return SelectionAdjustment.Companion.access$adjustByBoundary--Dv-ylE(SelectionAdjustment.Companion.$$INSTANCE, textLayoutResult, j, new adjust.boundaryFun.1(textLayoutResult.getLayoutInput().getText()));
    }
}
