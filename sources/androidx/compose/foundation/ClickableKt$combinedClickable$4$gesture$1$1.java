...
final class ClickableKt$combinedClickable$4$gesture$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class C03993 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        final /* synthetic */ MutableState<Function0<Boolean>> $delayPressInteraction;
        final /* synthetic */ boolean $enabled;
        final /* synthetic */ MutableInteractionSource $interactionSource;
        final /* synthetic */ MutableState<PressInteraction.Press> $pressedInteraction;
        ...
        C03993(boolean z, MutableInteractionSource mutableInteractionSource, MutableState<PressInteraction.Press> mutableState, MutableState<Function0<Boolean>> mutableState2, Continuation<? super C03993> continuation) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            return m1156invoked4ec7I((PressGestureScope) obj, ((Offset) obj2).m2566unboximpl(), (Continuation) obj3);
        }

        @Nullable
        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m1156invoked4ec7I(@NotNull PressGestureScope pressGestureScope, long j, @Nullable Continuation<? super Unit> continuation) {
            C03993 c03993 = new C03993(this.$enabled, this.$interactionSource, this.$pressedInteraction, this.$delayPressInteraction, continuation);
            c03993.L$0 = pressGestureScope;
            c03993.J$0 = j;
            return c03993.invokeSuspend(Unit.INSTANCE);
        }
        ...
        if (i == 0) {
            ...
            if (this.$hasDoubleClick && this.$enabled) {
                ...
                function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable$4$gesture$1$1.1
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(Object obj2) {
                        m1154invokek4lQ0M(((Offset) obj2).m2566unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1154invokek4lQ0M(long j) {
            ...
            if (this.$hasLongClick && this.$enabled) {
                ...
                function12 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable$4$gesture$1$1.2
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(Object obj2) {
                        m1155invokek4lQ0M(((Offset) obj2).m2566unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1155invokek4lQ0M(long j) {
            ...
            C03993 c03993 = new C03993(this.$enabled, this.$interactionSource, this.$pressedInteraction, this.$delayPressInteraction, null);
            ...
            Function1<Offset, Unit> function13 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable$4$gesture$1$1.4
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2) {
                    m1157invokek4lQ0M(((Offset) obj2).m2566unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m1157invokek4lQ0M(long j) {
                    if (z) {
            ...
            this.label = 1;
            if (TapGestureDetectorKt.detectTapGestures(pointerInputScope, function1, function12, c03993, function13, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
