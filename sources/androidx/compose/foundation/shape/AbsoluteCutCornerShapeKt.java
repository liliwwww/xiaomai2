...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m1678AbsoluteCutCornerShape0680j_4(float f) {
        return AbsoluteCutCornerShape(CornerSizeKt.m1686CornerSize0680j_4(f));
    }

    @NotNull
    /* renamed from: AbsoluteCutCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteCutCornerShape m1679AbsoluteCutCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m1686CornerSize0680j_4(f), CornerSizeKt.m1686CornerSize0680j_4(f2), CornerSizeKt.m1686CornerSize0680j_4(f3), CornerSizeKt.m1686CornerSize0680j_4(f4));
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ AbsoluteCutCornerShape m1680AbsoluteCutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1679AbsoluteCutCornerShapea9UjIt4(f, f2, f3, f4);
    }
