...
final class FlowLayoutKt$mainAxisColumnArrangement$1$1 extends Lambda implements Function5<Integer, int[], LayoutDirection, Density, int[], Unit> {
    final /* synthetic */ Arrangement$Vertical $verticalArrangement;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FlowLayoutKt$mainAxisColumnArrangement$1$1(Arrangement$Vertical arrangement$Vertical) {
        super(5);
