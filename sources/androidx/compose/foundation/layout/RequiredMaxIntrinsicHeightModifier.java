...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long m229calculateContentConstraintsl58MMJ0(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m2131fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m2122getMaxWidthimpl(j)));
    }
    ...
    public /* synthetic */ MeasureResult m230measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
