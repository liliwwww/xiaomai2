...
final class RequiredMinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m233calculateContentConstraintsl58MMJ0(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m2132fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m2121getMaxHeightimpl(j)));
    }
    ...
    public /* synthetic */ MeasureResult m234measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
