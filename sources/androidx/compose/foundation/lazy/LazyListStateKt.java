    ...
    public static final LazyListState rememberLazyListState(final int i, final int i2, @Nullable Composer composer, int i3, int i4) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Function0<LazyListState>() { // from class: androidx.compose.foundation.lazy.LazyListStateKt$rememberLazyListState$1$1
                ...
                public final LazyListState m1525invoke() {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m2434rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
