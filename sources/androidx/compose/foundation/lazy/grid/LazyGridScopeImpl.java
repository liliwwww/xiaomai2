...
public final class LazyGridScopeImpl implements LazyGridScope {
    ...
    private final Function2<LazyGridItemSpanScope, Integer, GridItemSpan> DefaultSpan = new Function2<LazyGridItemSpanScope, Integer, GridItemSpan>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridScopeImpl$DefaultSpan$1
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return GridItemSpan.m1534boximpl(m1581invoke_orMbw((LazyGridItemSpanScope) obj, ((Number) obj2).intValue()));
        }

        /* renamed from: invoke-_-orMbw, reason: not valid java name */
        public final long m1581invoke_orMbw(@NotNull LazyGridItemSpanScope lazyGridItemSpanScope, int i) {
    ...
    public void item(@Nullable final Object obj, @Nullable final Function1<? super LazyGridItemSpanScope, GridItemSpan> function1, @Nullable final Object obj2, @NotNull final Function3<? super LazyGridItemScope, ? super Composer, ? super Integer, Unit> function3) {
        ...
        this.intervals.addInterval(1, new LazyGridIntervalContent(obj != null ? new Function1<Integer, Object>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridScopeImpl$item$1$1
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj3, Object obj4) {
                return GridItemSpan.m1534boximpl(m1582invoke_orMbw((LazyGridItemSpanScope) obj3, ((Number) obj4).intValue()));
            }

            /* renamed from: invoke-_-orMbw, reason: not valid java name */
            public final long m1582invoke_orMbw(@NotNull LazyGridItemSpanScope lazyGridItemSpanScope, int i) {
                Intrinsics.checkNotNullParameter(lazyGridItemSpanScope, "$this$null");
                return ((GridItemSpan) function1.invoke(lazyGridItemSpanScope)).m1541unboximpl();
            }
