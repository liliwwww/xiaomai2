...
public final class LazyGridItemPlacementAnimator$onMeasured$$inlined$sortBy$1<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues((Integer) this.$previousKeyToIndexMap$inlined.get(((LazyGridPositionedItem) t).getKey()), (Integer) this.$previousKeyToIndexMap$inlined.get(((LazyGridPositionedItem) t2).getKey()));
    }
}
