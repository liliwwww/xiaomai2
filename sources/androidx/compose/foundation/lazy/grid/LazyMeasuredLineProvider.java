...
public final class LazyMeasuredLineProvider {
    ...
    public final long m1594childConstraintsJhjzzOo$foundation_release(int i, int i2) {
        ...
        return this.isVertical ? Constraints.Companion.m5194fixedWidthOenEA2s(coerceAtLeast) : Constraints.Companion.m5193fixedHeightOenEA2s(coerceAtLeast);
    }

    @NotNull
    /* renamed from: getAndMeasure-bKFJvoY, reason: not valid java name */
    public final LazyMeasuredLine m1595getAndMeasurebKFJvoY(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int m1538getCurrentLineSpanimpl = GridItemSpan.m1538getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).m1541unboximpl());
            LazyMeasuredItem m1592getAndMeasureednRnyU = this.measuredItemProvider.m1592getAndMeasureednRnyU(ItemIndex.m1544constructorimpl(lineConfiguration.getFirstItemIndex() + i4), i2, m1594childConstraintsJhjzzOo$foundation_release(i3, m1538getCurrentLineSpanimpl));
            i3 += m1538getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyMeasuredItemArr[i4] = m1592getAndMeasureednRnyU;
        }
        return this.measuredLineFactory.mo1578createLineH9FfpSk(i, lazyMeasuredItemArr, lineConfiguration.getSpans(), i2);
    }
