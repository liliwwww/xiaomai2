...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final float afterPadding(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        ...
        if (i == 1) {
            return z ? paddingValues.mo1377calculateTopPaddingD9Ej5fM() : paddingValues.mo1374calculateBottomPaddingD9Ej5fM();
        }
        if (i == 2) {
    ...
    public static final float beforePadding(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i == 1) {
            return z ? paddingValues.mo1374calculateBottomPaddingD9Ej5fM() : paddingValues.mo1377calculateTopPaddingD9Ej5fM();
        }
        if (i == 2) {
    ...
    */
    public static final kotlin.jvm.functions.Function2<androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.p004ui.unit.Constraints, androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureResult> rememberStaggeredGridMeasurePolicy(@org.jetbrains.annotations.NotNull final androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridState r16, @org.jetbrains.annotations.NotNull final androidx.compose.foundation.lazy.layout.LazyLayoutItemProvider r17, @org.jetbrains.annotations.NotNull final androidx.compose.foundation.layout.PaddingValues r18, final boolean r19, @org.jetbrains.annotations.NotNull final androidx.compose.foundation.gestures.Orientation r20, @org.jetbrains.annotations.NotNull final androidx.compose.foundation.layout.Arrangement.Vertical r21, @org.jetbrains.annotations.NotNull final androidx.compose.foundation.layout.Arrangement.Horizontal r22, @org.jetbrains.annotations.NotNull final kotlin.jvm.functions.Function2<? super androidx.compose.p004ui.unit.Density, ? super androidx.compose.p004ui.unit.Constraints, int[]> r23, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r24, int r25) {
        /*
    ...
    public static final float startPadding(PaddingValues paddingValues, Orientation orientation, LayoutDirection layoutDirection) {
        ...
        if (i == 2) {
            return paddingValues.mo1377calculateTopPaddingD9Ej5fM();
        }
        throw new NoWhenBranchMatchedException();
    }
}
