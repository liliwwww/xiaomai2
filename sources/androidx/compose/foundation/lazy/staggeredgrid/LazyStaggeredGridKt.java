...
public final class LazyStaggeredGridKt {
    ...
    public static final void LazyStaggeredGrid(@NotNull final LazyStaggeredGridState lazyStaggeredGridState, @NotNull final Orientation orientation, @NotNull final Function2<? super Density, ? super Constraints, int[]> function2, @Nullable Modifier modifier, @Nullable PaddingValues paddingValues, boolean z, @Nullable FlingBehavior flingBehavior, boolean z2, @Nullable Arrangement$Vertical arrangement$Vertical, @Nullable Arrangement$Horizontal arrangement$Horizontal, @NotNull final Function1<? super LazyStaggeredGridScope, Unit> function1, @Nullable Composer composer, final int i, final int i2, final int i3) {
        ...
        PaddingValues m325PaddingValues0680j_4 = (i3 & 16) != 0 ? PaddingKt.m325PaddingValues0680j_4(Dp.constructor-impl(0)) : paddingValues;
        ...
        Arrangement$Vertical top = (i3 & 256) != 0 ? Arrangement.INSTANCE.getTop() : arrangement$Vertical;
        Arrangement$Horizontal start = (i3 & 512) != 0 ? Arrangement.INSTANCE.getStart() : arrangement$Horizontal;
        ...
        Function2 rememberStaggeredGridMeasurePolicy = LazyStaggeredGridMeasurePolicyKt.rememberStaggeredGridMeasurePolicy(lazyStaggeredGridState, rememberStaggeredGridItemProvider, m325PaddingValues0680j_4, z3, orientation, top, start, function2, startRestartGroup, (i5 & 7168) | (i5 & 896) | 8 | ((i4 << 9) & 57344) | (458752 & i6) | (3670016 & i6) | ((i4 << 15) & 29360128));
        ...
        final PaddingValues paddingValues2 = m325PaddingValues0680j_4;
        final FlingBehavior flingBehavior3 = flingBehavior2;
        final boolean z6 = z4;
        final Arrangement$Vertical arrangement$Vertical2 = top;
        final Arrangement$Horizontal arrangement$Horizontal2 = start;
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(@Nullable Composer composer2, int i7) {
                LazyStaggeredGridKt.LazyStaggeredGrid(lazyStaggeredGridState, orientation, function2, modifier3, paddingValues2, z5, flingBehavior3, z6, arrangement$Vertical2, arrangement$Horizontal2, function1, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
            }
        });
    }
