...
public final class LazyListMeasureResult implements LazyListLayoutInfo, MeasureResult {
    ...
    public LazyListMeasureResult(@Nullable LazyMeasuredItem lazyMeasuredItem, int i, boolean z, float f, @NotNull MeasureResult measureResult, @NotNull List<? extends LazyListItemInfo> list, int i2, int i3, int i4, boolean z2, @NotNull Orientation orientation, int i5) {
