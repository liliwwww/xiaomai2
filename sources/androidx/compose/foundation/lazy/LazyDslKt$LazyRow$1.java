...
final class LazyDslKt$LazyRow$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    LazyDslKt$LazyRow$1(Modifier modifier, LazyListState lazyListState, PaddingValues paddingValues, boolean z, Arrangement.Horizontal horizontal, Alignment$Vertical alignment$Vertical, FlingBehavior flingBehavior, boolean z2, Function1<? super LazyListScope, Unit> function1, int i, int i2) {
        super(2);
