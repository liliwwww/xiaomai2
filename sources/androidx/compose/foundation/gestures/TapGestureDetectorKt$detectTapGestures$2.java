...
final class TapGestureDetectorKt$detectTapGestures$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            1 r1 = new 1(coroutineScope, this.$onPress, this.$onLongPress, this.$onDoubleTap, this.$onTap, pressGestureScopeImpl, (Continuation) null);
            this.label = 1;
            if (ForEachGestureKt.awaitEachGesture(pointerInputScope, r1, this) == coroutine_suspended) {
