...
final class TapGestureDetectorKt$detectTapGestures$2$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    TapGestureDetectorKt$detectTapGestures$2$1$2(Function3<? super PressGestureScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> function3, PressGestureScopeImpl pressGestureScopeImpl, PointerInputChange pointerInputChange, Continuation<? super TapGestureDetectorKt$detectTapGestures$2$1$2> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new TapGestureDetectorKt$detectTapGestures$2$1$2(this.$onPress, this.$pressScope, this.$down, continuation);
    }
