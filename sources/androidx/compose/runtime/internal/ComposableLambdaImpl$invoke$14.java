...
final class ComposableLambdaImpl$invoke$14 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull Composer composer, int i) {
        ...
        this.this$0.invoke(this.$p1, this.$p2, this.$p3, this.$p4, this.$p5, this.$p6, this.$p7, this.$p8, this.$p9, this.$p10, this.$p11, this.$p12, this.$p13, this.$p14, composer, this.$changed | 1, this.$changed1);
    }
}
