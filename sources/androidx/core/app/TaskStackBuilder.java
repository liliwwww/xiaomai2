...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public PendingIntent getPendingIntent(int i, int i2, @Nullable Bundle bundle) {
        ...
        return Build.VERSION.SDK_INT >= 16 ? Api16Impl.getActivities(this.mSourceContext, i, intentArr, i2, bundle) : PendingIntent.getActivities(this.mSourceContext, i, intentArr, i2);
    }
