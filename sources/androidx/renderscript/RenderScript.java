    ...
    */
    ...
    private static boolean setupNative(int i, Context context) {
        ...
        if (mBlackList.length() > 0) {
            if (mBlackList.contains('(' + com.alibaba.wireless.security.aopsdk.replace.android.os.Build.getMANUFACTURER() + ':' + com.alibaba.wireless.security.aopsdk.replace.android.os.Build.getPRODUCT() + ':' + com.alibaba.wireless.security.aopsdk.replace.android.os.Build.getMODEL() + ')')) {
                sNative = 0;
                return false;
            }
        }
    ...
    synchronized long nIncAllocationCreateTyped(long j, long j2) {
        validate();
