...
public final class c {
    ...
    static {
        ...
        while (true) {
            ...
            strArr[i2] = okhttp3.internal.a.q("%8s", new Object[]{Integer.toBinaryString(i2)}).replace(' ', '0');
            i2++;
        }
        String[] strArr2 = c;
        strArr2[0] = "";
    ...
    static String b(boolean z, int i, int i2, byte b2, byte b3) {
        String[] strArr = b;
        String q = b2 < strArr.length ? strArr[b2] : okhttp3.internal.a.q("0x%02x", new Object[]{Byte.valueOf(b2)});
        String a2 = a(b2, b3);
        ...
        objArr[3] = q;
        objArr[4] = a2;
        return okhttp3.internal.a.q("%s 0x%08x %5d %-13s %s", objArr);
    }

    static IllegalArgumentException c(String str, Object... objArr) {
        throw new IllegalArgumentException(okhttp3.internal.a.q(str, objArr));
    }

    static IOException d(String str, Object... objArr) throws IOException {
        throw new IOException(okhttp3.internal.a.q(str, objArr));
    }
}
