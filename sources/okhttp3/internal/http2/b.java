...
final class b {
    ...
    static final class a {
        ...
        ByteString j() throws IOException {
            ...
            boolean z = (i & 128) == 128;
            int m = m(i, 127);
            return z ? ByteString.of(g.f().c(this.b.readByteArray(m))) : this.b.readByteString(m);
        }
    ...
    static final class C0009b {
        ...
        void e(int i) {
            int min = Math.min(i, AccessibilityNodeInfoCompat.ACTION_COPY);
            int i2 = this.e;
            if (i2 == min) {
                return;
            }
        ...
        void g(List<okhttp3.internal.http2.a> list) throws IOException {
            int i;
            int i2;
            if (this.d) {
                int i3 = this.c;
        ...
        C0009b(int i, boolean z, Buffer buffer) {
            this.c = Integer.MAX_VALUE;
