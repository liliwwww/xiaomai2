...
public final class c {
    ...
    c(Set<b> set, @Nullable okhttp3.internal.tls.b bVar) {
        this.a = set;
        this.b = bVar;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof c) {
            c cVar = (c) obj;
            if (Objects.equals(this.b, cVar.b) && this.a.equals(cVar.a)) {
                return true;
            }
        }
        return false;
    ...
    c f(@Nullable okhttp3.internal.tls.b bVar) {
        return Objects.equals(this.b, bVar) ? this : new c(this.a, bVar);
    }
